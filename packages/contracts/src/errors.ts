...
export const API_ERROR_CODES = [
  ...
  'DESIGN_RUNTIME_REVISION_CONFLICT',
  'DESIGN_RUNTIME_NOT_COMPILED',
  'DESIGN_RUNTIME_REGISTRY_CHANGE_REQUIRES_UPGRADE',
  'DESIGN_RUNTIME_BINDING_NOT_FOUND',
  ...
  'DESIGN_RUNTIME_UPGRADE_CONFLICT',
  'DESIGN_RUNTIME_UPGRADE_INVALID',
  'DESIGN_RUNTIME_PREVIEW_CONFLICT',
  'DESIGN_RUNTIME_PREVIEW_INVALID',
  'DESIGN_RUNTIME_LEGACY_MIGRATION_CONFLICT',
  'DESIGN_RUNTIME_LEGACY_MIGRATION_INVALID',
  'DESIGN_RUNTIME_VERSION_NOT_FOUND',
  'DESIGN_RUNTIME_VERSION_INVALID',
  'DESIGN_RUNTIME_VERSION_IMMUTABLE',
  'DESIGN_RUNTIME_DEPENDENCY_INVALID',
  'DESIGN_RUNTIME_REGISTRY_LOCKED',
