...
describe('Design Loom distribution identity', () => {
  it('has its own installer, protocol, repository and disabled update policy', () => {
    expect(DESIGN_LOOM_PRODUCT).toMatchObject({ name: 'Design Loom', appId: 'io.github.linghaosu.designloom', protocol: 'designloom', namespace: 'design-loom', updatesEnabled: false });
