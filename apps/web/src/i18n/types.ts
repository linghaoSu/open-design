...
export interface Dict {
  "designWorkspace.noMatches": string;
  "designWorkspace.noComponents": string;
  "designWorkspace.backToComponents": string;
  "designWorkspace.migrationStepName": string;
  "designWorkspace.migrationStepFiles": string;
  "designWorkspace.migrationStepReview": string;
  "designWorkspace.lockedRegistry": string;
  "designWorkspace.noVersionComponents": string;
  "designWorkspace.openSource": string;
  ...
  "designMigration.noStylesheet": string;
  "designMigration.codeTitle": string;
  "designMigration.codeHint": string;
  "designMigration.addComponent": string;
  "designMigration.constraints": string;
  "designMigration.review": string;
  "designMigration.apply": string;
  "designMigration.ready": string;
  "designMigration.blocked": string;
  "designMigration.applied": string;
  "designMigration.stale": string;
  "designMigration.invalidResponse": string;
  "designMigration.converted": string;
  "designMigration.unresolved": string;
  "designMigration.compiled": string;
  "designMigration.packaged": string;
  "designMigration.tokenFoundation": string;
  "designMigration.readiness": string;
  "designMigration.proof": string;
  "designMigration.defaultName": string;
  "designMigration.noFiles": string;
  ...
  "designVersions.states": string;
  "designVersions.title": string;
  "designVersions.publishCurrent": string;
  "designVersions.publishHint": string;
  ...
  "designVersions.catalog": string;
  "designVersions.chooseVersion": string;
  "designVersions.packageDigest": string;
  "designVersions.sourceDigest": string;
  "designVersions.lockTitle": string;
  "designVersions.unlocked": string;
  "designVersions.range": string;
  "designVersions.activate": string;
  "designVersions.activateHint": string;
  "designVersions.resolve": string;
  "designVersions.resolved": string;
  "designVersions.clear": string;
  "designVersions.clearHint": string;
  "designVersions.published": string;
  "designVersions.imported": string;
  "designVersions.activated": string;
  "designVersions.cleared": string;
  "designVersions.staleRead": string;
  "designVersions.integrityHint": string;
  "designVersions.advanced": string;
  "designVersions.importPackage": string;
  "designVersions.exportPackage": string;
  "designVersions.importHint": string;
  "designVersions.invalidPackage": string;
  "designVersions.metadata": string;
  "designVersions.tokens": string;
  "designVersions.patterns": string;
  "designVersions.codeCompatibility": string;
  "designVersions.sourceEvidence": string;
  "designVersions.explore": string;
  "designVersions.guided": string;
  "designVersions.strict": string;
  "designVersions.off": string;
  "designVersions.warning": string;
  "designVersions.error": string;
  "designVersions.unknownComponents": string;
  "designVersions.unknownProps": string;
  "designVersions.invalidVariants": string;
  "designVersions.invalidSlots": string;
  "designVersions.undeclaredTokens": string;
  "designVersions.rawColors": string;
  "designVersions.rawRadius": string;
  ...
  'projectStructure.codeTab': string;
  'projectStructure.title': string;
  'projectStructure.screens': string;
  'projectStructure.sharedComponents': string;
  'projectStructure.newScreen': string;
  'projectStructure.empty': string;
  'projectStructure.componentName': string;
  'projectStructure.draft': string;
  'projectStructure.staged': string;
  'projectStructure.published': string;
  'projectStructure.documentDraft': string;
  'projectStructure.saveDocument': string;
  'projectStructure.validateDocument': string;
  'projectStructure.documentValid': string;
  'projectStructure.discardEdits': string;
  'projectStructure.documentConflict': string;
  'projectStructure.useDraft': string;
  'projectStructure.componentConflict': string;
  'projectStructure.rebase': string;
  'projectStructure.stage': string;
  'projectStructure.reviewImpact': string;
  'projectStructure.impact': string;
  'projectStructure.impactHint': string;
  'projectStructure.publish': string;
  'projectStructure.discardStage': string;
  'projectStructure.unstaged': string;
  'projectStructure.reviewAgain': string;
  'projectStructure.affectedScreens': string;
  'projectStructure.directUsages': string;
  'projectStructure.dependencyChains': string;
  'projectStructure.current': string;
  'projectStructure.proposed': string;
  'projectStructure.history': string;
  'projectStructure.stageUndo': string;
  'projectStructure.references': string;
  'projectStructure.analyzeDeletion': string;
  'projectStructure.deletionAction': string;
  'projectStructure.safeDelete': string;
  'projectStructure.replace': string;
  'projectStructure.detachAll': string;
  'projectStructure.deleteInstances': string;
  'projectStructure.replacement': string;
  'projectStructure.deleteComponent': string;
  'projectStructure.deletionHint': string;
  'projectStructure.detach': string;
  'projectStructure.detachMode': string;
  'projectStructure.explore': string;
  'projectStructure.guided': string;
  'projectStructure.strict': string;
  'projectStructure.previewDetach': string;
  'projectStructure.adoptDetach': string;
  'projectStructure.extractHint': string;
  'projectStructure.adoptExtraction': string;
  'projectStructure.sourceChanged': string;
  'projectStructure.publicProps': string;
  'projectStructure.addProp': string;
  'projectStructure.propName': string;
  'projectStructure.propType': string;
  'projectStructure.hasDefault': string;
  'projectStructure.defaultValue': string;
  'projectStructure.enumValues': string;
  'projectStructure.addValue': string;
  'projectStructure.addMapping': string;
  'projectStructure.mappingSource': string;
  'projectStructure.mappingTarget': string;
  'projectStructure.chooseTarget': string;
  'projectStructure.mappingHint': string;
  'projectStructure.nameRequired': string;
  'projectStructure.templateRequired': string;
  'projectStructure.staleRead': string;
  'projectStructure.conflict': string;
  'designValidation.title': string;
  'designValidation.description': string;
  'designValidation.mode': string;
  'designValidation.modeHint': string;
  'designValidation.saveSettings': string;
  'designValidation.effectivePolicy': string;
  'designValidation.projectPolicy': string;
  'designValidation.lockedPolicy': string;
  'designValidation.lockedHint': string;
  'designValidation.recoveryHint': string;
  'designValidation.sourceHint': string;
  'designValidation.outputs': string;
  'designValidation.addOutput': string;
  'designValidation.screen': string;
  'designValidation.unmapped': string;
  'designValidation.run': string;
  'designValidation.strictReady': string;
  'designValidation.notReady': string;
  'designValidation.accepted': string;
  'designValidation.rejected': string;
  'designValidation.coverage': string;
  'designValidation.metrics': string;
  'designValidation.semantic': string;
  'designValidation.source': string;
  'designValidation.imports': string;
  'designValidation.styles': string;
  'designValidation.bindings': string;
  'designValidation.conformance': string;
  'designValidation.componentReuse': string;
  'designValidation.bindingReuse': string;
  'designValidation.semanticReuse': string;
  'designValidation.intrinsicControls': string;
  'designValidation.duplicateControls': string;
  'designValidation.duplicateStructures': string;
  'designValidation.unsupported': string;
  'designValidation.unresolvedImports': string;
  'designValidation.staleResult': string;
  'designValidation.settingsConflict': string;
  'designValidation.rebase': string;
  'designValidation.dirtyHint': string;
