...
export const en: Dict = {
  ...
  "designGeneration.succeeded": "Generation completed",
  "designGeneration.blocked": "Delivery blocked",
  "designGeneration.canceled": "Generation canceled",
  "designGeneration.unconfirmed": "Awaiting delivery confirmation",
  "designGeneration.initial": "Initial attempt",
  "designGeneration.repair": "Repair attempt 1 of 1",
  "designGeneration.repairHint": "The daemon is making one repair attempt against the saved design policy. Delivery remains pending.",
  "designGeneration.blockedHint": "The saved design policy was not satisfied. Review the diagnostics before starting a new request.",
  "designGeneration.mode": "Saved mode",
  "designGeneration.revision": "Project revision",
  "designGeneration.decision": "Validation decision",
  "designGeneration.advisory": "Delivered with advisories",
  "designGeneration.accepted": "Validation passed",
  "designGeneration.notApplicable": "No applicable design output",
  "designGeneration.repairRequired": "Repair required",
  "designGeneration.inventoryComplete": "Source inventory is complete.",
  "designGeneration.inventoryIncomplete": "Source inventory is incomplete; coverage cannot be certified.",
  "designGeneration.evidence": "Report and source evidence",
  "designGeneration.reportHint": "Validation evidence belongs to the recorded source snapshot and saved policy. Physical process completion alone does not verify delivery.",
  "designGeneration.changed": "Changed source files",
  "designGeneration.deleted": "Deleted source files",
  "designGeneration.outputs": "Declared output files",
  "designGeneration.none": "None",
  "designGeneration.pending": "Validation evidence will appear when the current attempt finishes.",

  "designPreview.title": "Preview",
  "designPreview.open": "Preview components",
  "designPreview.hint": "Render real React or Vue components from the selected project revision. Comparisons are read-only.",
  "designPreview.kind": "Preview kind",
  "designPreview.semantic": "Semantic design",
  "designPreview.production": "Production handoff",
  "designPreview.framework": "Framework",
  "designPreview.draft": "Shared draft",
  "designPreview.currentOnly": "Current snapshot only",
  "designPreview.sharedComparison": "Shared draft comparison",
  "designPreview.upgradeComparison": "Reviewed upgrade comparison",
  "designPreview.clearComparison": "Clear comparison",
  "designPreview.semanticHint": "Local definitions expand into their inherited templates and render through frozen design-system source. Project implementations are not reused as proof of a proposed template.",
  "designPreview.productionHint": "Render current production implementations. Local bindings, source proofs, and installed package compatibility must be valid for each side.",
  "designPreview.screens": "Screens (up to six)",
  "designPreview.noScreens": "Save a semantic screen before previewing.",
  "designPreview.building": "Building preview…",
  "designPreview.build": "Build preview",
  "designPreview.failed": "Preview could not be prepared.",
  "designPreview.stale": "The selected project snapshot changed. Build a new preview.",
  "designPreview.impact": "Comparison scope",
  "designPreview.selected": "Selected visual sample",
  "designPreview.affected": "Affected screens from the reference graph or upgrade review",
  "designPreview.none": "None",
  "designPreview.sampleHint": "The selected screens are a visual sample. The affected-screen list retains the full graph or review scope; diagnostics indicate incomplete evidence.",
  "designPreview.current": "Current",
  "designPreview.proposed": "Proposed",
  "designPreview.revision": "Project revision",
  "designPreview.unavailable": "This side cannot be rendered. Review the diagnostics above.",
  "designPreview.evidence": "Source and package evidence",
  "designPreview.runtimeHint": "Framework runtime versions are supplied by OpenDesign. Installed project package observations and frozen design-system source are listed separately.",
  "designPreview.telemetryHint": "Rendered status reports browser execution; it does not certify production conformance. Runtime errors and blocked capabilities remain visible.",
  "designPreview.loading": "Loading component runtime…",
  "designPreview.rendered": "Rendered",
  "designPreview.error": "Rendering failed",
  "designPreview.timeout": "The component runtime did not report rendering before the timeout.",
  "designPreview.runtimeError": "The component runtime failed.",
  ...
  "designUpgrade.recipeUse": "Use recipe in plan",
  "designUpgrade.recipeEmpty": "This exact version has no recipe for the active dependency.",
  "designUpgrade.recipeHint": "Using a recipe fills the editable plan. Review and Apply remain separate.",
  "designUpgrade.recipeLoaded": "Recipe added to the editable plan. Review it before applying.",

  "designUpgrade.title": "Review a design system upgrade",
  "designUpgrade.hint": "Choose an exact published version, review its impact, then apply the reviewed changes.",
  "designUpgrade.target": "Target version",
  "designUpgrade.choose": "Choose an exact version",
  "designUpgrade.range": "Declared dependency range",
  "designUpgrade.editor": "Migration rules and binding decisions (JSON)",
  "designUpgrade.editorHint": "Rules run simultaneously against the old design system. Binding changes require an explicit decision. An empty plan preserves authored values and mappings.",
  "designUpgrade.vocabulary": "Migration examples",
  "designUpgrade.review": "Review upgrade",
  "designUpgrade.apply": "Apply reviewed upgrade",
  "designUpgrade.noLock": "Activate an exact design system version before reviewing an upgrade.",
  "designUpgrade.noTargets": "Publish or import another version of this design system to review an upgrade.",
  "designUpgrade.staleCatalog": "Refresh Versions to review the current project snapshot.",
  "designUpgrade.invalid": "The migration plan is invalid.",
  "designUpgrade.ready": "The proposed upgrade is ready to apply.",
  "designUpgrade.blocked": "Resolve the proposed diagnostics before applying.",
  "designUpgrade.applied": "The reviewed upgrade was applied.",
  "designUpgrade.current": "Current document diagnostics",
  "designUpgrade.proposed": "Proposed document diagnostics",
  "designUpgrade.planDiagnostics": "Migration and pending draft diagnostics",
  "designUpgrade.none": "None",
  "designUpgrade.diff": "Semantic changes",
  "designUpgrade.breaking": "Breaking change",
  "designUpgrade.screens": "Affected screens",
  "designUpgrade.usages": "Affected usages",
  "designUpgrade.overrides": "Invalid authored overrides",
  "designUpgrade.bindings": "Reviewed binding transitions",
  "designUpgrade.code": "Code impact",
  "designUpgrade.coverage": "Code impact covers registered bindings. Source changes conservatively include design system screens; token usage is not indexed.",
  "designUpgrade.documents": "Current and proposed resolved documents",
  "designUpgrade.proof": "Exact review evidence",
  "designUpgrade.loading": "Loading…",
  "designUpgrade.source": "Current version",
  "designUpgrade.readOnly": "You can review this upgrade, but applying it requires project write access.",

  "designVersions.states": "States",
  "designVersions.title": "Versions",
  "designVersions.publishCurrent": "Publish current registry",
  "designVersions.publishHint": "Freeze the current component registry, bindings, policies and selected source files as an immutable version.",
  "designVersions.name": "Design system name",
  "designVersions.version": "Exact version",
  "designVersions.sourceFiles": "Source files",
  "designVersions.authoringBase": "Editing baseline",
  "designVersions.authoringHint": "Metadata and unselected files are preserved from this exact version.",
  "designVersions.restoreAuthoringBase": "Use selected version as editing baseline",
  "designVersions.sourceUpdateHint": "Select files to update. Unselected files and binary assets keep their original bytes.",
  "designVersions.sourceHint": "Select every source and metadata file required by this version. Selected files are read as UTF-8 text.",
  "designVersions.constraints": "Constraint policies",
  "designVersions.constraintHint": "Explore defaults to warnings; Guided and Strict default to errors. Strict policies require every constraint to be an error.",
  "designVersions.catalog": "Published versions",
  "designVersions.chooseVersion": "Choose a version",
  "designVersions.packageDigest": "Package digest",
  "designVersions.sourceDigest": "Source digest",
  "designVersions.lockTitle": "Project version lock",
  "designVersions.unlocked": "No design system version is active.",
  "designVersions.range": "Allowed version range",
  "designVersions.activate": "Activate exact version",
  "designVersions.activateHint": "The range records your intent. This project keeps the exact selected version until you explicitly change it.",
  "designVersions.resolve": "Verify project lock",
  "designVersions.resolved": "Locked source and metadata verified.",
  "designVersions.clear": "Clear active dependency",
  "designVersions.clearHint": "Keep the current editable registry and explicitly remove the dependency and exact lock.",
  "designVersions.published": "Version published. The project lock has not changed.",
  "designVersions.imported": "Package imported. The project lock has not changed.",
  "designVersions.activated": "The selected exact version is now active.",
  "designVersions.cleared": "The active dependency and lock were cleared.",
  "designVersions.staleRead": "Project state changed. Refresh versions before using this result; your form edits are preserved.",
  "designVersions.integrityHint": "The active version could not be verified. Review the diagnostics, then explicitly clear the dependency to use the editable registry.",
  "designVersions.advanced": "Package import and export",
  "designVersions.importPackage": "Import package",
  "designVersions.exportPackage": "Export selected package",
  "designVersions.importHint": "Choose a complete design system package JSON file, review its identity, then import it. Binary source entries are supported in this format.",
  "designVersions.invalidPackage": "The file is not a valid design system package.",
  "designVersions.metadata": "Version contents",
  "designVersions.tokens": "Tokens",
  "designVersions.patterns": "Patterns",
  "designVersions.codeCompatibility": "Code compatibility",
  "designVersions.sourceEvidence": "Frozen source files",
  "designVersions.explore": "Explore",
  "designVersions.guided": "Guided",
  "designVersions.strict": "Strict",
  "designVersions.off": "Off",
  "designVersions.warning": "Warning",
  "designVersions.error": "Error",
  "designVersions.unknownComponents": "Unknown components",
  "designVersions.unknownProps": "Unknown props",
  "designVersions.invalidVariants": "Invalid variants",
  "designVersions.invalidSlots": "Invalid slots",
  "designVersions.undeclaredTokens": "Undeclared tokens",
  "designVersions.rawColors": "Raw colors",
  "designVersions.rawRadius": "Raw radius",
  "designVersions.rawSpacing": "Raw spacing",
  "designVersions.customControls": "Custom interactive controls",
  "designVersions.upgradeRequired": "Changing the locked version requires a reviewed design system upgrade.",

  'semanticEditor.title': "Semantic tree",
  'semanticEditor.screen': "Screen editor",
  'semanticEditor.screenName': "Screen name",
  'semanticEditor.template': "Component template",
  'semanticEditor.text': "Text",
  'semanticEditor.component': "Component",
  'semanticEditor.instance': "Instance",
  'semanticEditor.reference': "Component reference",
  'semanticEditor.addNode': "Add node",
  'semanticEditor.moveUp': "Move up",
  'semanticEditor.moveDown': "Move down",
  'semanticEditor.extract': "Extract shared component",
  'semanticEditor.newComponent': "New shared component",
  'semanticEditor.override': "Override {name}",
  'semanticEditor.reset': "Reset to component",
  'semanticEditor.inherited': "Inherited value",
  'semanticEditor.unset': "No inherited value",
  'semanticEditor.missingReference': "Unavailable component reference: {ref}",
  'semanticEditor.unknownProp': "Unknown property: {name}",
  'semanticEditor.unknownSlot': "Unknown slot: {name}",
  'semanticEditor.invalidNumber': "Enter a finite number.",
  'semanticEditor.noChoices': "No allowed choices",
  'semanticEditor.maxNodes': "At most {count} nodes are allowed here.",
  'semanticEditor.drivenBy': "Controlled by public property: {name}",
  'semanticEditor.mappedConflict': "This mapped target contains a duplicate explicit value. Remove it to restore the mapping.",
  'semanticEditor.invalidChild': "This node is not allowed in this slot.",
  'semanticEditor.invalidValue': "This value is outside the declared property contract.",
  "designRuntime.framework": "Framework",
  "designRuntime.metadataExport": "Slot metadata export (optional)",
  "designRuntime.metadataHint": "A named export declaring semantic slots and explicit code slot targets.",
  "designRuntime.stories": "Storybook examples",
  "designRuntime.storyHint": "Import literal CSF3 examples. Story args do not change production defaults.",
  "designRuntime.storySource": "Storybook source file",
  "designRuntime.storyExport": "Story export",
  "designRuntime.storyId": "Stable story ID",
  "designRuntime.addStorySource": "Add Storybook source",
  ...
  'designRuntime.conflict': "The registry changed. The latest revision is loaded; review your draft before trying again.",
  ...
  'designRuntime.exportName': "Export name",
  'designRuntime.identities': "Stable identities",
  'designRuntime.identityHint': "Assigned once; retained when source files or export names change.",
  'designRuntime.componentId': "Component ID",
  ...
  'designRuntime.required': "Required",
  'designRuntime.optional': "Optional",
  'designRuntime.multiple': "Multiple",
  'designRuntime.single': "Single",
  'designRuntime.binding': "Code binding",
  'designRuntime.status': "Status",
  'designRuntime.codeComponent': "Code component",
  'designRuntime.propMappings': "Property mappings",
  'designRuntime.bind': "Bind",
  'designRuntime.unbind': "Unbind",
  'designRuntime.revalidate': "Revalidate",
  'designRuntime.resolve': "Resolve",
  'designRuntime.resolved': "Resolved to {name}.",
  'designRuntime.validate': "Validate props",
  'designRuntime.includeProp': "Include {name}",
  'designRuntime.valueType': "Value type",
  'designRuntime.valid': "Property values are valid.",
  'designRuntime.props': "Props",
  'designRuntime.status.bound': "Bound",
  'designRuntime.status.unbound': "Unbound",
  'designRuntime.status.candidate': "Candidate",
  'designRuntime.status.stale': "Stale",
  'designRuntime.status.broken': "Broken",
  'designRuntime.boundTarget': "Current target",
  ...
  'settings.welcomeTitle': 'Welcome to Design Loom',
  'settings.welcomeSubtitle': '',
  'settings.onboardingCreateTitle': 'Start from a brief',
  'settings.onboardingCreateBody': 'Describe the site, app, deck, image, or video you want. Design Loom will create a project and keep the work editable.',
  ...
  'settings.onboardingMemoryCalloutBody': 'These answers seed your Memory profile. Design Loom reuses it on every task — and keeps learning as you work.',
  ...
  'settings.onboardingCloudTitle': 'Welcome to Design Loom',
  'settings.onboardingCloudBody': 'An independent local design tool. Use a local agent, your own API key, or third-party OpenDesign Cloud.',
  'settings.onboardingCloudSignIn': 'Sign in to OpenDesign Cloud',
  'settings.onboardingCloudContinue': 'OpenDesign Cloud · Continue (signed in)',
  'settings.onboardingCloudAlternative': 'Use a local CLI or your own API key',
  'settings.onboardingCloudRights': 'Based on OpenDesign',
  ...
  "settings.byokNoFileToolsNotice": "API mode can read, create, and modify project files. It requires an available OpenCode runtime, installed locally or bundled with the app.",
  ...
  'settings.agentInstall.pathHint': 'If you installed a CLI with npm or Homebrew and it still shows as not installed, ensure the tool\'s bin directory is on the PATH the Design Loom daemon inherits (Terminal vs GUI apps can differ on macOS). See QUICKSTART.md (section "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Open Install or Docs for your preferred agent.',
  'settings.agentInstall.stepAuth': 'Authenticate with the vendor CLI (sign in or add API credentials) before returning to Design Loom.',
  ...
  'settings.mcpServerHint': 'Expose Design Loom as an MCP server for your coding agent.',
  ...
  'settings.privacyHint': "Manage your saved data-sharing preferences.",
  'settings.privacyConsentKicker': "Data-sharing preferences",
  'settings.privacyConsentLead': "Manage your saved data-sharing preferences.",
  ...
  'settings.privacyConsentBannerFooter': "These switches save your preferences. Actual sharing also depends on the environment’s telemetry configuration.",
  'settings.privacyConsentPolicyLink': "Data handling details",
  'settings.privacyMetrics': 'Anonymous metrics',
  'settings.privacyMetricsHint': "Anonymous usage metrics may be sent only when telemetry is configured in this environment and this preference is on.",
  'settings.privacyContent': 'Conversation and tool content',
  'settings.privacyContentHint': "Prompts, assistant replies, and tool inputs/outputs may be sent only when telemetry is configured in this environment and this preference is on.",
  'settings.privacyInstallationId': 'Anonymous ID',
  'settings.privacyOptedOut': 'opted out',
  'settings.privacyDataDeletion': 'Delete my data',
  'settings.privacyDataDeletionHint': "Rotates your anonymous ID and turns off both telemetry preferences. It does not delete previously sent data; contact the configured recipient if needed.",
  ...
  "settings.allowSilentUpdatesDesc": "When an in-app update is ready, install it automatically the next time Design Loom starts. Does not upgrade the current session. Installer updates still ask first.",
  ...
  'settings.updateQuitFailed': 'The installer opened, but Design Loom could not quit automatically.',
  ...
  'settings.mcpTitle': 'Connect Design Loom to your coding agent',
  'settings.mcpHint': 'Use MCP to give supported agents access to your projects and design context.',
  'settings.mcpDaemonError': 'Couldn\'t reach the local daemon to resolve install paths ({error}). Make sure Design Loom is running, then reopen this panel.',
  ...
  'settings.mcpCapabilityDefault': 'Use the project and file currently open in Design Loom as context.',
  'settings.mcpRunningNote': 'Keep Design Loom running. Restart your coding agent after setup.',
  ...
  'socialShare.openDesignSection': 'Share Design Loom',
  'socialShare.openDesignTitle': 'Design Loom on GitHub',
  'socialShare.openDesignText': 'Design Loom is a source-available workspace for creating, editing, deploying, and handing off design artifacts.',
  ...
  "designFiles.fileTree": "File tree",
  "designFiles.categories": "By type",
  "designFiles.expandAll": "Expand all",
  "designFiles.collapseAll": "Collapse all",
  ...
  'projectStructure.codeTab': "Code components",
  'projectStructure.title': "Project structure",
  'projectStructure.screens': "Screens",
  'projectStructure.sharedComponents': "Shared components",
  'projectStructure.newScreen': "New screen",
  'projectStructure.empty': "Create a screen or shared component to start editing the project structure.",
  'projectStructure.componentName': "Component name",
  'projectStructure.draft': "Local draft",
  'projectStructure.staged': "Staged change",
  'projectStructure.published': "Published",
  'projectStructure.documentDraft': "Screen edits stay in this draft until you save the document.",
  'projectStructure.saveDocument': "Save document",
  'projectStructure.validateDocument': "Validate document",
  'projectStructure.documentValid': "The document is valid.",
  'projectStructure.discardEdits': "Discard local edits",
  'projectStructure.documentConflict': "The saved document changed. Your draft is preserved. Discard it to load the saved version, or explicitly use your draft with the latest revision.",
  'projectStructure.useDraft': "Use my draft with latest revision",
  'projectStructure.componentConflict': "This component has a newer published revision or staged change. Reload it or explicitly rebase your draft before staging.",
  'projectStructure.rebase': "Rebase draft",
  'projectStructure.stage': "Stage change",
  'projectStructure.reviewImpact': "Review impact",
  'projectStructure.impact': "Change impact",
  'projectStructure.impactHint': "Impact compares published definitions against this staged change in saved screens. Unsaved screen edits are excluded.",
  'projectStructure.publish': "Publish change",
  'projectStructure.discardStage': "Discard staged change",
  'projectStructure.unstaged': "The editor differs from the staged change. Stage these edits before publishing.",
  'projectStructure.reviewAgain': "Review impact at the current project revision before publishing.",
  'projectStructure.affectedScreens': "Affected screens",
  'projectStructure.directUsages': "Direct usages",
  'projectStructure.dependencyChains': "Dependency chains",
  'projectStructure.current': "Current",
  'projectStructure.proposed': "Proposed",
  'projectStructure.history': "Published history",
  'projectStructure.stageUndo': "Stage undo to revision {revision}",
  'projectStructure.references': "References and deletion",
  'projectStructure.analyzeDeletion': "Analyze references and deletion",
  'projectStructure.deletionAction': "Deletion action",
  'projectStructure.safeDelete': "Delete only if unused",
  'projectStructure.replace': "Replace references",
  'projectStructure.detachAll': "Detach references",
  'projectStructure.deleteInstances': "Delete component and its instances",
  'projectStructure.replacement': "Replacement component",
  'projectStructure.deleteComponent': "Apply deletion action",
  'projectStructure.deletionHint': "This action updates the saved project and its references. Save or discard screen drafts first.",
  'projectStructure.detach': "Detach an instance",
  'projectStructure.detachMode': "Validation mode",
  'projectStructure.explore': "Explore",
  'projectStructure.guided': "Guided",
  'projectStructure.strict': "Strict",
  'projectStructure.previewDetach': "Preview detached content",
  'projectStructure.adoptDetach': "Use detached content in draft",
  'projectStructure.extractHint': "Stage and publish this shared component first. Then use its instance in the screen draft and save the document.",
  'projectStructure.adoptExtraction': "Use published component in screen",
  'projectStructure.sourceChanged': "The source node changed or was removed. Your draft was preserved; restart extraction or detach from the current node.",
  'projectStructure.publicProps': "Public properties",
  'projectStructure.addProp': "Add public property",
  'projectStructure.propName': "Property name",
  'projectStructure.propType': "Property type",
  'projectStructure.hasDefault': "Has default",
  'projectStructure.defaultValue': "Default value",
  'projectStructure.enumValues': "Enum values",
  'projectStructure.addValue': "Add value",
  'projectStructure.addMapping': "Add mapping",
  'projectStructure.mappingSource': "Public property",
  'projectStructure.mappingTarget': "Template target",
  'projectStructure.chooseTarget': "Choose a template target",
  'projectStructure.mappingHint': "Mapped targets inherit the public property. Remove duplicate explicit values in the template before staging.",
  'projectStructure.nameRequired': "Enter a unique, valid property name.",
  'projectStructure.templateRequired': "Add one template root before staging.",
  'projectStructure.staleRead': "The project changed while this result was loading. Your drafts are preserved; review the latest state and try again.",
  'projectStructure.conflict': "The latest project state is loaded. Your drafts are preserved; review changes before retrying.",
  'designValidation.title': "Validation",
  'designValidation.description': "Check saved semantic screens against project source files and the effective design policy.",
  'designValidation.mode': "Project mode",
  'designValidation.modeHint': "Save your mode before validating. Explore and Guided use their configured severities; Strict requires complete evidence.",
  'designValidation.saveSettings': "Save validation settings",
  'designValidation.effectivePolicy': "Effective policy",
  'designValidation.projectPolicy': "Project policy",
  'designValidation.lockedPolicy': "Locked package policy",
  'designValidation.lockedHint': "The exact locked package supplies the policy. Clear the dependency before editing these constraints.",
  'designValidation.recoveryHint': "The locked package cannot be verified. To recover, explicitly save Explore mode here, then clear the dependency in Versions.",
  'designValidation.sourceHint': "Select entry files and every imported application source or stylesheet. The daemon reads source bytes and installed packages.",
  'designValidation.outputs': "Screen outputs",
  'designValidation.addOutput': "Add output",
  'designValidation.screen': "Semantic screen",
  'designValidation.unmapped': "Unmapped — advisory analysis only",
  'designValidation.run': "Validate artifacts",
  'designValidation.strictReady': "Strict proof complete",
  'designValidation.notReady': "Strict proof incomplete",
  'designValidation.accepted': "Accepted by saved policy",
  'designValidation.rejected': "Rejected by saved policy",
  'designValidation.coverage': "Evidence coverage",
  'designValidation.metrics': "Measured results",
  'designValidation.semantic': "Semantic document",
  'designValidation.source': "Static source",
  'designValidation.imports': "Import graph",
  'designValidation.styles': "Styles",
  'designValidation.bindings': "Production bindings",
  'designValidation.conformance': "Source matches semantic screens",
  'designValidation.componentReuse': "Component reuse",
  'designValidation.bindingReuse': "Binding reuse",
  'designValidation.semanticReuse': "Known semantic components",
  'designValidation.intrinsicControls': "Intrinsic controls",
  'designValidation.duplicateControls': "Controls with bound replacements",
  'designValidation.duplicateStructures': "Repeated control structures",
  'designValidation.unsupported': "Unsupported constructs",
  'designValidation.unresolvedImports': "Unresolved imports",
  'designValidation.staleResult': "The project changed after this result. Validate again to inspect current facts.",
  'designValidation.settingsConflict': "The project changed. Your settings draft is preserved; refresh and use the current revision before saving.",
  'designValidation.rebase': "Use current revision",
  'designValidation.dirtyHint': "You have unsaved settings. Artifact validation uses the saved mode and policy.",
  'designValidation.noSources': "Choose at least one source file and a screen output.",
  'designValidation.clearHint': "Clearing a verified dependency keeps its constraints and your selected mode.",

  "designHandoff.title": "Handoff",
  "designHandoff.description": "Connect reusable project components to production code, then review and export an engineering handoff.",
  "designHandoff.framework": "Framework",
  "designHandoff.localCode": "Local component implementations",
  "designHandoff.localComponent": "Reusable component",
  "designHandoff.definitionRevision": "Definition revision {revision}",
  "designHandoff.implementation": "Implementation",
  "designHandoff.registerSource": "Register a project source file",
  "designHandoff.existingCode": "Use registered or design system code",
  "designHandoff.bindingId": "Binding ID",
  "designHandoff.register": "Verify and bind implementation",
  "designHandoff.noLocal": "Create a reusable component in Structure to register its implementation.",
  "designHandoff.mappingHint": "Mappings use designProp and codeProp. For typed value conversion, add valueTransform: {\"type\":\"map\",\"entries\":[{\"from\":\"primary\",\"to\":\"filled\"}]}. Slot mappings use designSlot and codeSlot.",
  "designHandoff.valueTransform": "Value conversion (JSON)",
  "designHandoff.transformHint": "Leave empty for identity. Use {\"valueTransform\":{\"type\":\"map\",\"entries\":[{\"from\":\"primary\",\"to\":\"filled\"}]}}. Existing legacy values mappings are preserved until edited.",
  "designHandoff.invalidTransform": "Enter a JSON object containing values or valueTransform only.",
  "designHandoff.refreshFiles": "Reload state and file list",
  "designHandoff.sourceProof": "The daemon verifies frozen design system bytes, current registered source, and actual installed package versions. Emission returns files for download.",
  "designHandoff.handoffId": "Handoff ID",
  "designHandoff.changeContext": "Published change context (optional)",
  "designHandoff.previousVersion": "Exact previous design system version",
  "designHandoff.create": "Create handoff",
  "designHandoff.outputs": "Screen output files",
  "designHandoff.emit": "Emit production code",
  "designHandoff.ready": "Ready",
  "designHandoff.notReady": "Not ready",
  "designHandoff.downloadManifest": "Download handoff JSON",
  "designHandoff.downloadCode": "Download code",
  "designHandoff.registeredCode": "Registered project code",
  "designHandoff.refreshHint": "Refresh reads the registered source again. Unavailable or changed code leaves bindings broken or stale until explicit revalidation succeeds.",
  "designHandoff.refreshCode": "Refresh source",
  "designHandoff.conflict": "The project changed. Your binding draft is preserved. Reload the binding before submitting again.",
  "designHandoff.dirty": "You have unsaved binding edits. Save or reload before selecting another component or framework.",
  ...
  "designOverview.lockedVersion": "Locked · {version}",
  "designOverview.editingVersion": "Editing from {version}",
  "designOverview.unpublished": "Unpublished collection",
  "designOverview.lockedHint": "This project uses an exact published version. Styles and source files remain frozen with it.",
  "designOverview.editingHint": "Styles and source files are preserved from the editing baseline. Publish a new version when your changes are ready.",
  "designOverview.unpublishedHint": "Your component collection is editable. Publish a version to preserve its styles and source files.",
  "designOverview.foundations": "Foundations",
  "designOverview.codeComponents": "Code components",
  "designOverview.pages": "Pages",
  "designOverview.sources": "Preserved source files",
  "designOverview.versionContents": "View version contents",
  "designOverview.manageVersion": "Manage version",
  "designOverview.continueEditing": "Continue editing",
  "designOverview.lockedNext": "To make changes, clear the active dependency in Versions. Published versions stay unchanged.",
  "designOverview.loading": "Loading version contents…",
  "designOverview.unavailable": "Version contents could not be verified. Refresh to try again.",
  "designOverview.notPublished": "Not published",
  "designOverview.metadataOnly": "Tokens and source files are separate from code components and pages.",

  "settings.byokRuntimeMissing": "No available OpenCode detected",
  "settings.byokRuntimeMissingHint": "API runs cannot start until OpenCode is available. Install it, then rescan, or rescan an existing installation.",
  "settings.byokRuntimeReady": "OpenCode available",
  "settings.byokRuntimeConnectionHint": "Connection tests check the API provider only. They do not verify that OpenCode can start.",

  "settings.byokRuntimeUnknown": "OpenCode availability has not been confirmed. Rescan to check.",
  ...
  "settings.privacyConfigured": "Telemetry is configured in this environment. Sending depends on the data type and its settings; this status does not confirm any upload.",
  "settings.privacyUnconfigured": "Telemetry is not configured in this environment. The switches show saved preferences, not upload activity.",
  "settings.privacyConfigurationUnknown": "The telemetry configuration for this environment could not be confirmed. The switches only show your saved preferences.",
  "settings.privacyProviderHint": "Model requests are still processed by your selected provider. These two telemetry preferences do not control those requests.",
};
