...
export const fa: Dict = {
  ...
  "designUpgrade.choose": "انتخاب نسخهٔ دقیق",
  "designUpgrade.range": "بازهٔ وابستگی اعلام‌شده",
  "designUpgrade.editor": "قواعد مهاجرت و تصمیم‌های اتصال (JSON)",
  "designUpgrade.editorHint": "قواعد هم‌زمان بر سیستم طراحی قدیمی اعمال می‌شوند. تغییر اتصال‌ها به تصمیم صریح نیاز دارد. طرح خالی مقادیر و نگاشت‌های موجود را حفظ می‌کند.",
  "designUpgrade.vocabulary": "نمونه‌های مهاجرت",
  "designUpgrade.review": "بررسی ارتقا",
  "designUpgrade.apply": "اعمال ارتقای بررسی‌شده",
  "designUpgrade.noLock": "پیش از بررسی ارتقا، نسخهٔ دقیق سیستم طراحی را فعال کنید.",
  "designUpgrade.noTargets": "برای بررسی ارتقا، نسخهٔ دیگری از این سیستم طراحی را منتشر یا وارد کنید.",
  "designUpgrade.staleCatalog": "نسخه‌ها را تازه‌سازی کنید تا تصویر فعلی پروژه بررسی شود.",
  "designUpgrade.invalid": "طرح مهاجرت نامعتبر است.",
  "designUpgrade.ready": "ارتقای پیشنهادی آمادهٔ اعمال است.",
  "designUpgrade.blocked": "پیش از اعمال، مشکلات تشخیصی پیشنهاد را برطرف کنید.",
  "designUpgrade.applied": "ارتقای بررسی‌شده اعمال شد.",
  "designUpgrade.current": "گزارش‌های تشخیصی سند فعلی",
  "designUpgrade.proposed": "گزارش‌های تشخیصی سند پیشنهادی",
  "designUpgrade.planDiagnostics": "گزارش‌های مهاجرت و پیش‌نویس‌های معلق",
  "designUpgrade.none": "هیچ‌کدام",
  "designUpgrade.diff": "تغییرات معنایی",
  "designUpgrade.breaking": "تغییر ناسازگار",
  "designUpgrade.screens": "صفحه‌های تحت تأثیر",
  "designUpgrade.usages": "کاربردهای تحت تأثیر",
  "designUpgrade.overrides": "بازنویسی‌های صریح نامعتبر",
  "designUpgrade.bindings": "تغییرات اتصال بررسی‌شده",
  "designUpgrade.code": "اثر بر کد",
  "designUpgrade.coverage": "اثر بر کد اتصال‌های ثبت‌شده را پوشش می‌دهد. تغییرات منبع، صفحه‌های سیستم طراحی را با احتیاط شامل می‌شود؛ کاربرد توکن‌ها نمایه‌سازی نشده است.",
  "designUpgrade.documents": "سند فعلی و پیشنهادی با ارجاع‌های حل‌شده",
  "designUpgrade.proof": "شواهد دقیق بررسی",
  "designUpgrade.loading": "در حال بارگذاری…",
  "designUpgrade.source": "نسخهٔ فعلی",
  "designUpgrade.readOnly": "می‌توانید این ارتقا را بررسی کنید، اما اعمال آن به دسترسی نوشتن در پروژه نیاز دارد.",

  "designVersions.states": "حالت‌ها",
  "designVersions.title": "نسخه‌ها",
  "designVersions.publishCurrent": "انتشار رجیستری فعلی",
  "designVersions.publishHint": "رجیستری مؤلفه‌ها، اتصال‌ها، سیاست‌ها و فایل‌های منبع انتخاب‌شده را به‌صورت نسخه‌ای تغییرناپذیر تثبیت کنید.",
  "designVersions.name": "نام سیستم طراحی",
  "designVersions.version": "نسخهٔ دقیق",
  "designVersions.sourceFiles": "فایل‌های منبع",
  "designVersions.authoringBase": "مبنای ویرایش",
  "designVersions.authoringHint": "فراداده و فایل‌های انتخاب‌نشده از همین نسخهٔ دقیق حفظ می‌شوند.",
  "designVersions.restoreAuthoringBase": "استفاده از نسخهٔ انتخاب‌شده به‌عنوان مبنای ویرایش",
  "designVersions.sourceUpdateHint": "فایل‌های موردنظر برای به‌روزرسانی را انتخاب کنید. بایت‌های اصلی فایل‌های انتخاب‌نشده و دارایی‌های دودویی حفظ می‌شوند.",
  "designVersions.sourceHint": "همهٔ فایل‌های منبع و فرادادهٔ موردنیاز این نسخه را انتخاب کنید. فایل‌های انتخاب‌شده به‌صورت متن UTF-8 خوانده می‌شوند.",
  "designVersions.constraints": "سیاست‌های محدودیت",
  "designVersions.constraintHint": "حالت کاوش به‌طور پیش‌فرض از هشدار و حالت‌های هدایت‌شده و سخت‌گیرانه از خطا استفاده می‌کنند. سیاست‌های سخت‌گیرانه باید هر محدودیت را روی خطا تنظیم کنند.",
  "designVersions.catalog": "نسخه‌های منتشرشده",
  "designVersions.chooseVersion": "انتخاب نسخه",
  "designVersions.packageDigest": "هش بسته",
  "designVersions.sourceDigest": "هش منبع",
  "designVersions.lockTitle": "قفل نسخهٔ پروژه",
  "designVersions.unlocked": "هیچ نسخه‌ای از سیستم طراحی فعال نیست.",
  "designVersions.range": "بازهٔ نسخه‌های مجاز",
  "designVersions.activate": "فعال‌سازی نسخهٔ دقیق",
  "designVersions.activateHint": "بازه، قصد شما را ثبت می‌کند. پروژه نسخهٔ دقیق انتخاب‌شده را تا زمانی که صریحاً تغییرش دهید نگه می‌دارد.",
  "designVersions.resolve": "تأیید قفل پروژه",
  "designVersions.resolved": "منبع و فرادادهٔ قفل‌شده تأیید شدند.",
  "designVersions.clear": "حذف وابستگی فعال",
  "designVersions.clearHint": "رجیستری قابل‌ویرایش فعلی را نگه دارید و وابستگی و قفل نسخهٔ دقیق را صریحاً حذف کنید.",
  "designVersions.published": "نسخه منتشر شد. قفل پروژه تغییری نکرد.",
  "designVersions.imported": "بسته وارد شد. قفل پروژه تغییری نکرد.",
  "designVersions.activated": "نسخهٔ دقیق انتخاب‌شده اکنون فعال است.",
  "designVersions.cleared": "وابستگی فعال و قفل حذف شدند.",
  "designVersions.staleRead": "وضعیت پروژه تغییر کرده است. پیش از استفاده از این نتیجه، نسخه‌ها را تازه‌سازی کنید؛ ویرایش‌های فرم حفظ شده‌اند.",
  "designVersions.integrityHint": "نسخهٔ فعال قابل‌تأیید نیست. پیام‌های تشخیصی را بررسی کنید، سپس وابستگی را صریحاً حذف کنید تا از رجیستری قابل‌ویرایش استفاده شود.",
  "designVersions.advanced": "ورود و خروج بسته",
  "designVersions.importPackage": "وارد کردن بسته",
  "designVersions.exportPackage": "خروجی گرفتن از بستهٔ انتخاب‌شده",
  "designVersions.importHint": "یک فایل JSON کامل از بستهٔ سیستم طراحی انتخاب کنید، شناسهٔ آن را بررسی کنید و سپس وارد کنید. این قالب از ورودی‌های منبع دودویی پشتیبانی می‌کند.",
  "designVersions.invalidPackage": "این فایل یک بستهٔ معتبر سیستم طراحی نیست.",
  "designVersions.metadata": "محتویات نسخه",
  "designVersions.tokens": "توکن‌ها",
  "designVersions.patterns": "الگوها",
  "designVersions.codeCompatibility": "سازگاری کد",
  "designVersions.sourceEvidence": "فایل‌های منبع تثبیت‌شده",
  "designVersions.explore": "کاوش",
  "designVersions.guided": "هدایت‌شده",
  "designVersions.strict": "سخت‌گیرانه",
  "designVersions.off": "خاموش",
  "designVersions.warning": "هشدار",
  "designVersions.error": "خطا",
  "designVersions.unknownComponents": "مؤلفه‌های ناشناخته",
  "designVersions.unknownProps": "ویژگی‌های ناشناخته",
  "designVersions.invalidVariants": "گونه‌های نامعتبر",
  "designVersions.invalidSlots": "اسلات‌های نامعتبر",
  "designVersions.undeclaredTokens": "توکن‌های تعریف‌نشده",
  "designVersions.rawColors": "رنگ‌های مستقیم",
  "designVersions.rawRadius": "شعاع‌های مستقیم",
  "designVersions.rawSpacing": "فاصله‌های مستقیم",
  "designVersions.customControls": "کنترل‌های تعاملی سفارشی",
  "designVersions.upgradeRequired": "تغییر نسخهٔ قفل‌شده به ارتقای بازبینی‌شدهٔ سیستم طراحی نیاز دارد.",

  'semanticEditor.title': "درخت معنایی",
  'semanticEditor.screen': "ویرایشگر صفحه",
  'semanticEditor.screenName': "نام صفحه",
  'semanticEditor.template': "قالب جزء",
  'semanticEditor.text': "متن",
  'semanticEditor.component': "جزء",
  'semanticEditor.instance': "نمونه",
  'semanticEditor.reference': "ارجاع جزء",
  'semanticEditor.addNode': "افزودن گره",
  'semanticEditor.moveUp': "انتقال به بالا",
  'semanticEditor.moveDown': "انتقال به پایین",
  'semanticEditor.extract': "استخراج جزء مشترک",
  'semanticEditor.newComponent': "جزء مشترک جدید",
  'semanticEditor.override': "بازنویسی {name}",
  'semanticEditor.reset': "بازنشانی به مقدار جزء",
  'semanticEditor.inherited': "مقدار ارث‌برده",
  'semanticEditor.unset': "بدون مقدار ارث‌برده",
  'semanticEditor.missingReference': "ارجاع جزء در دسترس نیست: {ref}",
  'semanticEditor.unknownProp': "ویژگی ناشناخته: {name}",
  'semanticEditor.unknownSlot': "جایگاه ناشناخته: {name}",
  'semanticEditor.invalidNumber': "یک عدد متناهی وارد کنید.",
  'semanticEditor.noChoices': "هیچ گزینه مجازی وجود ندارد",
  'semanticEditor.maxNodes': "در اینجا حداکثر {count} گره مجاز است.",
  'semanticEditor.drivenBy': "کنترل‌شده توسط ویژگی عمومی: {name}",
  'semanticEditor.mappedConflict': "این هدف نگاشت یک مقدار صریح تکراری دارد. برای بازیابی نگاشت آن را حذف کنید.",
  'semanticEditor.invalidChild': "این گره در این جایگاه مجاز نیست.",
  'semanticEditor.invalidValue': "این مقدار با قرارداد اعلام‌شده ویژگی مطابقت ندارد.",
  "designRuntime.framework": "چارچوب",
  "designRuntime.metadataExport": "خروجی فرادادهٔ اسلات‌ها (اختیاری)",
  "designRuntime.metadataHint": "یک خروجی نام‌دار، اسلات‌های معنایی و مقصدهای صریح آن‌ها در کد را تعریف می‌کند.",
  "designRuntime.stories": "نمونه‌های Storybook",
  "designRuntime.storyHint": "نمونه‌های CSF3 با مقادیر ثابت را وارد کنید. آرگومان‌های داستان مقدارهای پیش‌فرض تولید را تغییر نمی‌دهند.",
  "designRuntime.storySource": "فایل منبع Storybook",
  "designRuntime.storyExport": "خروجی داستان",
  "designRuntime.storyId": "شناسهٔ ثابت داستان",
  "designRuntime.addStorySource": "افزودن منبع Storybook",
  ...
  'designRuntime.conflict': "رجیستری تغییر کرده است. آخرین بازبینی بارگیری شد؛ پیش از تلاش دوباره پیش‌نویس را بررسی کنید.",
  ...
  'designRuntime.exportName': "نام خروجی",
  'designRuntime.identities': "شناسه‌های پایدار",
  'designRuntime.identityHint': "یک بار اختصاص می‌یابند و با تغییر فایل منبع یا نام خروجی حفظ می‌شوند.",
  'designRuntime.componentId': "شناسه جزء",
  ...
  'designRuntime.required': "الزامی",
  'designRuntime.optional': "اختیاری",
  'designRuntime.multiple': "چندگانه",
  'designRuntime.single': "تکی",
  'designRuntime.binding': "پیوند کد",
  'designRuntime.status': "وضعیت",
  'designRuntime.codeComponent': "جزء کد",
  'designRuntime.propMappings': "نگاشت ویژگی‌ها",
  'designRuntime.bind': "پیوند",
  'designRuntime.unbind': "قطع پیوند",
  'designRuntime.revalidate': "اعتبارسنجی مجدد",
  'designRuntime.resolve': "حل پیوند",
  'designRuntime.resolved': "به {name} حل شد.",
  'designRuntime.validate': "اعتبارسنجی ویژگی‌ها",
  'designRuntime.includeProp': "شامل {name}",
  'designRuntime.valueType': "نوع مقدار",
  'designRuntime.valid': "مقادیر ویژگی‌ها معتبر هستند.",
  'designRuntime.props': "ویژگی‌ها",
  'designRuntime.status.bound': "پیوندخورده",
  'designRuntime.status.unbound': "بدون پیوند",
  'designRuntime.status.candidate': "نامزد",
  'designRuntime.status.stale': "قدیمی",
  'designRuntime.status.broken': "خراب",
  'designRuntime.boundTarget': "هدف فعلی",
  ...
  'settings.welcomeTitle': 'به Design Loom خوش آمدید',
  'settings.welcomeSubtitle': '',
  'settings.onboardingCreateTitle': 'شروع با یک شرح',
  'settings.onboardingCreateBody': 'سایت، اپلیکیشن، ارائه، تصویر یا ویدیویی را که می‌خواهید توصیف کنید. Design Loom یک پروژه می‌سازد و کار را قابل ویرایش نگه می‌دارد.',
  ...
  'settings.onboardingMemoryCalloutBody': 'این پاسخ‌ها نمایهٔ حافظهٔ شما را شکل می‌دهند. Design Loom در هر کار از آن استفاده می‌کند و همزمان با کار شما به یادگیری ادامه می‌دهد.',
  ...
  'settings.onboardingCloudTitle': 'به Design Loom خوش آمدید',
  'settings.onboardingCloudBody': 'یک ابزار طراحی محلی و مستقل. از یک عامل محلی، کلید API خودتان یا سرویس شخص ثالث OpenDesign Cloud استفاده کنید.',
  'settings.onboardingCloudSignIn': 'ورود به OpenDesign Cloud',
  'settings.onboardingCloudContinue': 'OpenDesign Cloud · ادامه (وارد شده‌اید)',
  'settings.onboardingCloudAlternative': 'از یک CLI محلی یا کلید API خودتان استفاده کنید',
  'settings.onboardingCloudRights': 'بر پایهٔ OpenDesign',
  ...
  "settings.byokNoFileToolsNotice": "حالت API می‌تواند فایل‌های پروژه را بخواند، ایجاد و ویرایش کند. این حالت به OpenCode قابل استفاده نیاز دارد که محلی نصب شده یا همراه برنامه ارائه شده باشد.",
  ...
  'settings.agentInstall.stepAuth': 'قبل از بازگشت به Design Loom، در CLI ارائه‌دهنده احراز هویت کنید (ورود یا افزودن اطلاعات API).',
  ...
  'settings.mcpServerHint': 'Design Loom را به‌عنوان سرور MCP برای عامل برنامه‌نویسی خود در دسترس قرار دهید.',
  ...
  'settings.privacyHint': "تنظیمات ذخیره‌شدهٔ اشتراک‌گذاری داده را مدیریت کنید.",
  'settings.privacyConsentKicker': "تنظیمات اشتراک‌گذاری داده",
  'settings.privacyConsentLead': "تنظیمات ذخیره‌شدهٔ اشتراک‌گذاری داده را مدیریت کنید.",
  ...
  'settings.privacyConsentBannerFooter': "این کلیدها ترجیحات شما را ذخیره می‌کنند. اشتراک‌گذاری واقعی به پیکربندی تله‌متری محیط نیز بستگی دارد.",
  'settings.privacyConsentPolicyLink': "جزئیات پردازش داده‌ها",
  'settings.privacyMetrics': 'معیارهای ناشناس',
  'settings.privacyMetricsHint': "معیارهای استفادهٔ ناشناس فقط زمانی می‌توانند ارسال شوند که تله‌متری در این محیط پیکربندی شده و این گزینه روشن باشد.",
  'settings.privacyContent': 'محتوای مکالمه و ابزار',
  'settings.privacyContentHint': "پرامپت‌ها، پاسخ‌های دستیار و ورودی‌ها و خروجی‌های ابزار فقط زمانی می‌توانند ارسال شوند که تله‌متری در این محیط پیکربندی شده و این گزینه روشن باشد.",
  ...
  'settings.privacyDataDeletionHint': "شناسهٔ ناشناس شما را عوض می‌کند و هر دو گزینهٔ تله‌متری را خاموش می‌کند. داده‌های قبلاً ارسال‌شده حذف نمی‌شوند؛ در صورت نیاز با گیرندهٔ پیکربندی‌شده تماس بگیرید.",
  ...
  'settings.updateQuitFailed': 'نصب‌کننده باز شد، اما Design Loom نتوانست خودکار خارج شود.',
  ...
  'settings.mcpDaemonError': 'امکان دسترسی به daemon محلی برای تعیین مسیرهای نصب وجود نداشت ({error}). مطمئن شوید که Design Loom در حال اجراست، سپس این پنل را دوباره باز کنید.',
  ...
  'settings.mcpCapabilityDefault': 'به‌صورت پیش‌فرض از پروژه و فایلی که در Design Loom باز کرده‌اید استفاده می‌کند، بنابراین می‌توانید بگویید «این را در اپ من بساز» بدون اینکه دوباره مشخص کنید کدام طراحی.',
  'settings.mcpRunningNote': 'برای موفقیت فراخوانی‌های ابزار MCP، Design Loom باید در حال اجرا باشد. اگر Agent کدنویسی خود را پیش از باز کردن Design Loom راه‌اندازی کرده‌اید، Agent را راه‌اندازی مجدد کنید تا بتواند به daemon زنده دسترسی پیدا کند.',
  ...
  'socialShare.openDesignSection': 'اشتراک‌گذاری Design Loom',
  'socialShare.openDesignTitle': 'Design Loom در GitHub',
  'socialShare.openDesignText': 'Design Loom یک فضای کاری با کد منبع در دسترس برای ساخت، ویرایش، استقرار و تحویل آرتیفکت‌های طراحی است.',
  ...
  "designFiles.fileTree": "درخت فایل‌ها",
  "designFiles.categories": "بر اساس نوع",
  "designFiles.expandAll": "باز کردن همه",
  "designFiles.collapseAll": "بستن همه",
  ...
  'labs.title': "آزمایشگاه Design Loom",
  ...
  'projectStructure.codeTab': "مؤلفه‌های کد",
  'projectStructure.title': "ساختار پروژه",
  'projectStructure.screens': "صفحه‌ها",
  'projectStructure.sharedComponents': "مؤلفه‌های مشترک",
  'projectStructure.newScreen': "صفحه جدید",
  'projectStructure.empty': "برای شروع ویرایش ساختار پروژه، یک صفحه یا مؤلفه مشترک ایجاد کنید.",
  'projectStructure.componentName': "نام مؤلفه",
  'projectStructure.draft': "پیش‌نویس محلی",
  'projectStructure.staged': "تغییر آماده‌شده",
  'projectStructure.published': "منتشرشده",
  'projectStructure.documentDraft': "ویرایش‌های صفحه تا زمان ذخیره سند در این پیش‌نویس باقی می‌مانند.",
  'projectStructure.saveDocument': "ذخیره سند",
  'projectStructure.validateDocument': "اعتبارسنجی سند",
  'projectStructure.documentValid': "سند معتبر است.",
  'projectStructure.discardEdits': "کنار گذاشتن ویرایش‌های محلی",
  'projectStructure.documentConflict': "سند ذخیره‌شده تغییر کرده است. پیش‌نویس شما حفظ شده است. برای بارگذاری نسخه ذخیره‌شده آن را کنار بگذارید، یا صریحاً اعمال پیش‌نویس بر آخرین بازبینی را انتخاب کنید.",
  'projectStructure.useDraft': "اعمال پیش‌نویس من بر آخرین بازبینی",
  'projectStructure.componentConflict': "این مؤلفه بازبینی منتشرشده یا تغییر آماده‌شده جدیدتری دارد. پیش از آماده‌سازی تغییر، آن را دوباره بارگذاری کنید یا مبنای پیش‌نویس را صریحاً به‌روز کنید.",
  'projectStructure.rebase': "به‌روزرسانی مبنای پیش‌نویس",
  'projectStructure.stage': "آماده‌سازی تغییر",
  'projectStructure.reviewImpact': "بررسی تأثیر",
  'projectStructure.impact': "تأثیر تغییر",
  'projectStructure.impactHint': "تحلیل، تعریف‌های منتشرشده را با این تغییر آماده‌شده در صفحه‌های ذخیره‌شده مقایسه می‌کند. ویرایش‌های ذخیره‌نشده صفحه‌ها در نظر گرفته نمی‌شوند.",
  'projectStructure.publish': "انتشار تغییر",
  'projectStructure.discardStage': "کنار گذاشتن تغییر آماده‌شده",
  'projectStructure.unstaged': "محتوای ویرایشگر با تغییر آماده‌شده متفاوت است. پیش از انتشار، این ویرایش‌ها را آماده کنید.",
  'projectStructure.reviewAgain': "پیش از انتشار، تأثیر را روی بازبینی فعلی پروژه بررسی کنید.",
  'projectStructure.affectedScreens': "صفحه‌های تحت تأثیر",
  'projectStructure.directUsages': "استفاده‌های مستقیم",
  'projectStructure.dependencyChains': "زنجیره‌های وابستگی",
  'projectStructure.current': "فعلی",
  'projectStructure.proposed': "پیشنهادی",
  'projectStructure.history': "تاریخچه انتشار",
  'projectStructure.stageUndo': "آماده‌سازی بازگردانی به بازبینی {revision}",
  'projectStructure.references': "ارجاع‌ها و حذف",
  'projectStructure.analyzeDeletion': "تحلیل ارجاع‌ها و حذف",
  'projectStructure.deletionAction': "عملیات حذف",
  'projectStructure.safeDelete': "حذف فقط در صورت استفاده نشدن",
  'projectStructure.replace': "جایگزینی ارجاع‌ها",
  'projectStructure.detachAll': "جدا کردن ارجاع‌ها",
  'projectStructure.deleteInstances': "حذف مؤلفه و نمونه‌های آن",
  'projectStructure.replacement': "مؤلفه جایگزین",
  'projectStructure.deleteComponent': "اعمال عملیات حذف",
  'projectStructure.deletionHint': "این عملیات پروژه ذخیره‌شده و ارجاع‌های آن را به‌روز می‌کند. ابتدا پیش‌نویس‌های صفحه‌ها را ذخیره کنید یا کنار بگذارید.",
  'projectStructure.detach': "جدا کردن نمونه",
  'projectStructure.detachMode': "حالت اعتبارسنجی",
  'projectStructure.explore': "کاوش",
  'projectStructure.guided': "هدایت‌شده",
  'projectStructure.strict': "سخت‌گیرانه",
  'projectStructure.previewDetach': "پیش‌نمایش محتوای جداشده",
  'projectStructure.adoptDetach': "استفاده از محتوای جداشده در پیش‌نویس",
  'projectStructure.extractHint': "ابتدا این مؤلفه مشترک را آماده و منتشر کنید. سپس نمونه آن را در پیش‌نویس صفحه به کار ببرید و سند را ذخیره کنید.",
  'projectStructure.adoptExtraction': "استفاده از مؤلفه منتشرشده در صفحه",
  'projectStructure.sourceChanged': "گره مبدأ تغییر کرده یا حذف شده است. پیش‌نویس شما حفظ شده است؛ استخراج را دوباره شروع کنید یا گره فعلی را جدا کنید.",
  'projectStructure.publicProps': "ویژگی‌های عمومی",
  'projectStructure.addProp': "افزودن ویژگی عمومی",
  'projectStructure.propName': "نام ویژگی",
  'projectStructure.propType': "نوع ویژگی",
  'projectStructure.hasDefault': "دارای مقدار پیش‌فرض",
  'projectStructure.defaultValue': "مقدار پیش‌فرض",
  'projectStructure.enumValues': "مقادیر شمارشی",
  'projectStructure.addValue': "افزودن مقدار",
  'projectStructure.addMapping': "افزودن نگاشت",
  'projectStructure.mappingSource': "ویژگی عمومی",
  'projectStructure.mappingTarget': "هدف الگو",
  'projectStructure.chooseTarget': "انتخاب هدف در الگو",
  'projectStructure.mappingHint': "هدف‌های نگاشت‌شده ویژگی عمومی را به ارث می‌برند. پیش از آماده‌سازی تغییر، مقادیر صریح تکراری را از الگو حذف کنید.",
  'projectStructure.nameRequired': "نامی یکتا و معتبر برای ویژگی وارد کنید.",
  'projectStructure.templateRequired': "پیش از آماده‌سازی تغییر، یک ریشه به الگو اضافه کنید.",
  'projectStructure.staleRead': "پروژه هنگام بارگذاری این نتیجه تغییر کرده است. پیش‌نویس‌های شما حفظ شده‌اند؛ آخرین وضعیت را بررسی کنید و دوباره تلاش کنید.",
  'projectStructure.conflict': "آخرین وضعیت پروژه بارگذاری شد. پیش‌نویس‌های شما حفظ شده‌اند؛ پیش از تلاش مجدد تغییرات را بررسی کنید.",
  'designValidation.title': "اعتبارسنجی",
  'designValidation.description': "صفحه‌های معنایی ذخیره‌شده را با فایل‌های منبع پروژه و سیاست طراحی مؤثر بررسی کنید.",
  'designValidation.mode': "حالت پروژه",
  'designValidation.modeHint': "پیش از اعتبارسنجی، حالت را ذخیره کنید. حالت‌های کاوش و هدایت‌شده از سطوح شدت تنظیم‌شده استفاده می‌کنند؛ حالت سخت‌گیرانه به شواهد کامل نیاز دارد.",
  'designValidation.saveSettings': "ذخیره تنظیمات اعتبارسنجی",
  'designValidation.effectivePolicy': "سیاست مؤثر",
  'designValidation.projectPolicy': "سیاست پروژه",
  'designValidation.lockedPolicy': "سیاست بسته قفل‌شده",
  'designValidation.lockedHint': "بسته قفل‌شده روی نسخه دقیق، سیاست را تأمین می‌کند. پیش از ویرایش این محدودیت‌ها وابستگی را حذف کنید.",
  'designValidation.recoveryHint': "بسته قفل‌شده قابل تأیید نیست. برای بازیابی، ابتدا حالت کاوش را به‌صراحت اینجا ذخیره کنید و سپس وابستگی را در بخش نسخه‌ها حذف کنید.",
  'designValidation.sourceHint': "فایل‌های ورودی و همه منابع برنامه یا شیوه‌نامه‌های واردشده را انتخاب کنید. سرویس پس‌زمینه بایت‌های منبع و بسته‌های نصب‌شده را می‌خواند.",
  'designValidation.outputs': "خروجی‌های صفحه",
  'designValidation.addOutput': "افزودن خروجی",
  'designValidation.screen': "صفحه معنایی",
  'designValidation.unmapped': "بدون نگاشت — فقط تحلیل راهنما",
  'designValidation.run': "اعتبارسنجی خروجی‌ها",
  'designValidation.strictReady': "شواهد حالت سخت‌گیرانه کامل است",
  'designValidation.notReady': "شواهد حالت سخت‌گیرانه ناقص است",
  'designValidation.accepted': "پذیرفته‌شده طبق سیاست ذخیره‌شده",
  'designValidation.rejected': "ردشده طبق سیاست ذخیره‌شده",
  'designValidation.coverage': "پوشش شواهد",
  'designValidation.metrics': "نتایج اندازه‌گیری‌شده",
  'designValidation.semantic': "سند معنایی",
  'designValidation.source': "منبع ایستا",
  'designValidation.imports': "گراف واردسازی",
  'designValidation.styles': "سبک‌ها",
  'designValidation.bindings': "اتصال‌های کد تولید",
  'designValidation.conformance': "منبع با صفحه‌های معنایی مطابقت دارد",
  'designValidation.componentReuse': "استفاده مجدد از مؤلفه‌ها",
  'designValidation.bindingReuse': "استفاده مجدد از اتصال‌ها",
  'designValidation.semanticReuse': "مؤلفه‌های معنایی شناخته‌شده",
  'designValidation.intrinsicControls': "کنترل‌های بومی HTML",
  'designValidation.duplicateControls': "کنترل‌های دارای جایگزین متصل",
  'designValidation.duplicateStructures': "ساختارهای تکراری کنترل",
  'designValidation.unsupported': "ساختارهای پشتیبانی‌نشده",
  'designValidation.unresolvedImports': "واردسازی‌های حل‌نشده",
  'designValidation.staleResult': "پروژه پس از این نتیجه تغییر کرده است. برای بررسی وضعیت فعلی دوباره اعتبارسنجی کنید.",
  'designValidation.settingsConflict': "پروژه تغییر کرده است. پیش‌نویس تنظیمات شما حفظ شده؛ تازه‌سازی کنید و پیش از ذخیره از بازبینی فعلی استفاده کنید.",
  'designValidation.rebase': "استفاده از بازبینی فعلی",
  'designValidation.dirtyHint': "تنظیمات ذخیره‌نشده دارید. اعتبارسنجی خروجی‌ها از حالت و سیاست ذخیره‌شده استفاده می‌کند.",
  'designValidation.noSources': "دست‌کم یک فایل منبع و یک خروجی صفحه انتخاب کنید.",
  'designValidation.clearHint': "حذف وابستگی تأییدشده، محدودیت‌های آن و حالت انتخابی شما را حفظ می‌کند.",

  'designHandoff.title': "تحویل",
  'designHandoff.description': "مؤلفه‌های قابل استفاده مجدد پروژه را به کد تولید متصل کنید، سپس تحویل مهندسی را بازبینی و صادر کنید.",
  'designHandoff.framework': "چارچوب",
  'designHandoff.localCode': "پیاده‌سازی مؤلفه‌های محلی",
  'designHandoff.localComponent': "مؤلفه قابل استفاده مجدد",
  'designHandoff.definitionRevision': "بازبینی تعریف {revision}",
  'designHandoff.implementation': "پیاده‌سازی",
  'designHandoff.registerSource': "ثبت فایل منبع پروژه",
  'designHandoff.existingCode': "استفاده از کد ثبت‌شده یا کد سیستم طراحی",
  'designHandoff.bindingId': "شناسه اتصال",
  'designHandoff.register': "تأیید و اتصال پیاده‌سازی",
  'designHandoff.noLocal': "برای ثبت پیاده‌سازی، در بخش ساختار یک مؤلفه قابل استفاده مجدد بسازید.",
  'designHandoff.mappingHint': "نگاشت‌ها از designProp و codeProp استفاده می‌کنند. برای تبدیل نوع‌دار مقادیر، valueTransform: {\"type\":\"map\",\"entries\":[{\"from\":\"primary\",\"to\":\"filled\"}]} را اضافه کنید. نگاشت شیارها از designSlot و codeSlot استفاده می‌کند.",
  'designHandoff.valueTransform': "تبدیل مقدار (JSON)",
  'designHandoff.transformHint': "برای حفظ مقدارها خالی بگذارید. از {\"valueTransform\":{\"type\":\"map\",\"entries\":[{\"from\":\"primary\",\"to\":\"filled\"}]}} استفاده کنید. نگاشت‌های قدیمی values تا زمان ویرایش حفظ می‌شوند.",
  'designHandoff.invalidTransform': "یک شیء JSON وارد کنید که فقط شامل values یا valueTransform باشد.",
  'designHandoff.refreshFiles': "بارگیری مجدد وضعیت و فهرست فایل‌ها",
  'designHandoff.sourceProof': "سرویس پس‌زمینه بایت‌های ثابت‌شده سیستم طراحی، منبع ثبت‌شده فعلی و نسخه واقعی بسته‌های نصب‌شده را تأیید می‌کند. تولید کد فایل‌هایی برای دانلود برمی‌گرداند.",
  'designHandoff.handoffId': "شناسه تحویل",
  'designHandoff.changeContext': "زمینه تغییرات منتشرشده (اختیاری)",
  'designHandoff.previousVersion': "نسخه دقیق قبلی سیستم طراحی",
  'designHandoff.create': "ایجاد تحویل",
  'designHandoff.outputs': "فایل‌های خروجی صفحه",
  'designHandoff.emit': "تولید کد نهایی",
  'designHandoff.ready': "آماده",
  'designHandoff.notReady': "آماده نیست",
  'designHandoff.downloadManifest': "دانلود JSON تحویل",
  'designHandoff.downloadCode': "دانلود کد",
  'designHandoff.registeredCode': "کد ثبت‌شده پروژه",
  'designHandoff.refreshHint': "تازه‌سازی، منبع ثبت‌شده را دوباره می‌خواند. کد تغییرکرده یا غیرقابل دسترس، اتصال‌ها را تا موفقیت اعتبارسنجی مجدد صریح، خراب یا قدیمی نگه می‌دارد.",
  'designHandoff.refreshCode': "تازه‌سازی منبع",
  'designHandoff.conflict': "پروژه تغییر کرده است. پیش‌نویس اتصال حفظ شده است. پیش از ارسال مجدد، اتصال را دوباره بارگیری کنید.",
  'designHandoff.dirty': "ویرایش‌های ذخیره‌نشده اتصال دارید. پیش از انتخاب مؤلفه یا چارچوب دیگر، ذخیره یا بارگیری مجدد کنید.",
  ...
  'designPreview.title': "پیش‌نمایش",
  'designPreview.open': "پیش‌نمایش مؤلفه‌ها",
  'designPreview.hint': "مؤلفه‌های واقعی React یا Vue را از بازبینی انتخاب‌شدهٔ پروژه نمایش دهید. مقایسه‌ها فقط خواندنی هستند.",
  'designPreview.kind': "نوع پیش‌نمایش",
  'designPreview.semantic': "طراحی معنایی",
  'designPreview.production': "تحویل کد عملیاتی",
  'designPreview.framework': "چارچوب",
  'designPreview.draft': "پیش‌نویس مؤلفهٔ مشترک",
  'designPreview.currentOnly': "فقط تصویر فعلی",
  'designPreview.sharedComparison': "مقایسهٔ پیش‌نویس مؤلفهٔ مشترک",
  'designPreview.upgradeComparison': "مقایسهٔ ارتقای بازبینی‌شده",
  'designPreview.clearComparison': "پاک کردن مقایسه",
  'designPreview.semanticHint': "تعریف‌های محلی به قالب‌های به‌ارث‌رسیدهٔ خود گسترش می‌یابند و با منبع ثابت‌شدهٔ سیستم طراحی نمایش داده می‌شوند. پیاده‌سازی پروژه به‌عنوان مدرک قالب پیشنهادی دوباره استفاده نمی‌شود.",
  'designPreview.productionHint': "پیاده‌سازی عملیاتی فعلی را نمایش دهید. اتصال‌های محلی، مدارک منبع و سازگاری بسته‌های نصب‌شده باید در هر دو سمت معتبر باشند.",
  'designPreview.screens': "صفحه‌ها (حداکثر شش مورد)",
  'designPreview.noScreens': "پیش از پیش‌نمایش، یک صفحهٔ معنایی ذخیره کنید.",
  'designPreview.building': "در حال ساخت پیش‌نمایش…",
  'designPreview.build': "ساخت پیش‌نمایش",
  'designPreview.failed': "آماده‌سازی پیش‌نمایش ممکن نشد.",
  'designPreview.stale': "تصویر انتخاب‌شدهٔ پروژه تغییر کرده است. پیش‌نمایش تازه‌ای بسازید.",
  'designPreview.impact': "دامنهٔ مقایسه",
  'designPreview.selected': "نمونهٔ بصری انتخاب‌شده",
  'designPreview.affected': "صفحه‌های متأثر از نمودار ارجاع‌ها یا بازبینی ارتقا",
  'designPreview.none': "هیچ‌کدام",
  'designPreview.sampleHint': "صفحه‌های انتخاب‌شده یک نمونهٔ بصری هستند. فهرست صفحه‌های متأثر کل دامنهٔ نمودار یا بازبینی را حفظ می‌کند؛ پیام‌های تشخیصی مدارک ناقص را نشان می‌دهند.",
  'designPreview.current': "فعلی",
  'designPreview.proposed': "پیشنهادی",
  'designPreview.revision': "بازبینی پروژه",
  'designPreview.unavailable': "این سمت قابل نمایش نیست. پیام‌های تشخیصی بالا را بررسی کنید.",
  'designPreview.evidence': "مدارک منبع و بسته‌ها",
  'designPreview.runtimeHint': "نسخه‌های محیط اجرای چارچوب را OpenDesign فراهم می‌کند. مشاهدات بسته‌های نصب‌شدهٔ پروژه و منبع ثابت‌شدهٔ سیستم طراحی جداگانه فهرست می‌شوند.",
  'designPreview.telemetryHint': "وضعیت نمایش‌یافته اجرای مرورگر را گزارش می‌کند و انطباق عملیاتی را تأیید نمی‌کند. خطاهای زمان اجرا و قابلیت‌های مسدودشده همچنان نمایش داده می‌شوند.",
  'designPreview.loading': "در حال بارگذاری محیط اجرای مؤلفه…",
  'designPreview.rendered': "نمایش داده شد",
  'designPreview.error': "نمایش ناموفق بود",
  'designPreview.timeout': "محیط اجرای مؤلفه پیش از پایان مهلت، تکمیل نمایش را گزارش نکرد.",
  'designPreview.runtimeError': "محیط اجرای مؤلفه دچار خطا شد.",

  "designGeneration.title": "اعتبارسنجی طراحی",
  "designGeneration.running": "تولید در حال انجام است",
  "designGeneration.repairing": "اصلاح در حال انجام است",
  "designGeneration.succeeded": "تولید تکمیل شد",
  "designGeneration.blocked": "تحویل مسدود شد",
  "designGeneration.canceled": "تولید لغو شد",
  "designGeneration.unconfirmed": "در انتظار تأیید تحویل",
  "designGeneration.initial": "تلاش نخست",
  "designGeneration.repair": "تلاش اصلاح ۱ از ۱",
  "designGeneration.repairHint": "سرویس پس‌زمینه طبق سیاست طراحی ذخیره‌شده یک بار برای اصلاح تلاش می‌کند. تحویل همچنان در انتظار است.",
  "designGeneration.blockedHint": "سیاست طراحی ذخیره‌شده رعایت نشده است. پیش از شروع درخواست جدید، نتایج عیب‌یابی را بررسی کنید.",
  "designGeneration.mode": "حالت ذخیره‌شده",
  "designGeneration.revision": "بازبینی پروژه",
  "designGeneration.decision": "تصمیم اعتبارسنجی",
  "designGeneration.advisory": "با نکات مشورتی تحویل داده شد",
  "designGeneration.accepted": "اعتبارسنجی موفق بود",
  "designGeneration.notApplicable": "خروجی طراحی مشمولی وجود ندارد",
  "designGeneration.repairRequired": "اصلاح لازم است",
  "designGeneration.inventoryComplete": "فهرست فایل‌های منبع کامل است.",
  "designGeneration.inventoryIncomplete": "فهرست فایل‌های منبع ناقص است؛ پوشش را نمی‌توان تأیید کرد.",
  "designGeneration.evidence": "گزارش و شواهد منبع",
  "designGeneration.reportHint": "شواهد اعتبارسنجی به تصویر ثبت‌شدهٔ منبع و سیاست ذخیره‌شده مربوط‌اند. پایان فرایند به‌تنهایی تحویل را تأیید نمی‌کند.",
  "designGeneration.changed": "فایل‌های منبع تغییرکرده",
  "designGeneration.deleted": "فایل‌های منبع حذف‌شده",
  "designGeneration.outputs": "فایل‌های خروجی اعلام‌شده",
  "designGeneration.none": "هیچ‌کدام",
  "designGeneration.pending": "شواهد اعتبارسنجی پس از پایان تلاش فعلی نمایش داده می‌شوند.",
  "designOverview.lockedVersion": "قفل‌شده · {version}",
  "designOverview.editingVersion": "ویرایش بر پایهٔ {version}",
  "designOverview.unpublished": "مجموعهٔ منتشرنشده",
  "designOverview.lockedHint": "این پروژه از یک نسخهٔ منتشرشدهٔ مشخص استفاده می‌کند. سبک‌ها و فایل‌های منبع همراه با آن نسخه ثابت می‌مانند.",
  "designOverview.editingHint": "سبک‌ها و فایل‌های منبع از نسخهٔ مبنای ویرایش حفظ می‌شوند. وقتی تغییرات آماده شد، نسخهٔ جدیدی منتشر کنید.",
  "designOverview.unpublishedHint": "مجموعهٔ مؤلفه‌های شما قابل ویرایش است. برای حفظ سبک‌ها و فایل‌های منبع آن، یک نسخه منتشر کنید.",
  "designOverview.foundations": "مبانی طراحی",
  "designOverview.codeComponents": "مؤلفه‌های کد",
  "designOverview.pages": "صفحه‌ها",
  "designOverview.sources": "فایل‌های منبع حفظ‌شده",
  "designOverview.versionContents": "مشاهدهٔ محتوای نسخه",
  "designOverview.manageVersion": "مدیریت نسخه",
  "designOverview.continueEditing": "ادامهٔ ویرایش",
  "designOverview.lockedNext": "برای ایجاد تغییر، وابستگی فعال را در بخش نسخه‌ها حذف کنید. نسخه‌های منتشرشده بدون تغییر می‌مانند.",
  "designOverview.loading": "در حال بارگذاری محتوای نسخه…",
  "designOverview.unavailable": "محتوای نسخه قابل تأیید نبود. برای تلاش دوباره، صفحه را تازه‌سازی کنید.",
  "designOverview.notPublished": "منتشر نشده",
  "designOverview.metadataOnly": "توکن‌ها و فایل‌های منبع جدا از مؤلفه‌های کد و صفحه‌ها نگهداری می‌شوند.",

  "settings.byokRuntimeMissing": "OpenCode قابل استفاده پیدا نشد",
  "settings.byokRuntimeMissingHint": "تا زمانی که OpenCode در دسترس نباشد، وظایف API شروع نمی‌شوند. آن را نصب و دوباره اسکن کنید، یا نصب موجود را دوباره اسکن کنید.",
  "settings.byokRuntimeReady": "OpenCode در دسترس است",
  "settings.byokRuntimeConnectionHint": "آزمایش اتصال فقط ارائه‌دهندهٔ API را بررسی می‌کند و تأیید نمی‌کند که OpenCode قابل اجراست.",
  ...
  "settings.privacyConfigured": "تله‌متری در این محیط پیکربندی شده است. ارسال به نوع داده و تنظیمات مربوط به آن بستگی دارد؛ این وضعیت هیچ بارگذاری‌ای را تأیید نمی‌کند.",
  "settings.privacyUnconfigured": "تله‌متری در این محیط پیکربندی نشده است. کلیدها تنظیمات ذخیره‌شده را نشان می‌دهند، نه فعالیت بارگذاری.",
  "settings.privacyConfigurationUnknown": "پیکربندی تله‌متری این محیط قابل تأیید نیست. کلیدها فقط تنظیمات ذخیره‌شدهٔ شما را نشان می‌دهند.",
  "settings.privacyProviderHint": "درخواست‌های مدل همچنان توسط ارائه‌دهندهٔ انتخابی شما پردازش می‌شوند. این دو تنظیم تله‌متری، آن درخواست‌ها را کنترل نمی‌کنند.",
};
