...
export const zhTW: Dict = {
  ...
  "designUpgrade.choose": "選擇確切版本",
  "designUpgrade.range": "宣告的相依版本範圍",
  "designUpgrade.editor": "遷移規則與綁定決策（JSON）",
  "designUpgrade.editorHint": "規則同時作用於舊設計系統。綁定變更必須明確指定。空白計畫會保留既有值與對應。",
  "designUpgrade.vocabulary": "遷移範例",
  "designUpgrade.review": "審查升級",
  "designUpgrade.apply": "套用已審查的升級",
  "designUpgrade.noLock": "審查升級前，請先啟用確切的設計系統版本。",
  "designUpgrade.noTargets": "發佈或匯入此設計系統的另一個版本，即可審查升級。",
  "designUpgrade.staleCatalog": "重新整理「版本」以審查目前的專案快照。",
  "designUpgrade.invalid": "遷移計畫無效。",
  "designUpgrade.ready": "提議的升級已可套用。",
  "designUpgrade.blocked": "套用前請解決提議中的診斷問題。",
  "designUpgrade.applied": "已套用審查後的升級。",
  "designUpgrade.current": "目前文件診斷",
  "designUpgrade.proposed": "提議文件診斷",
  "designUpgrade.planDiagnostics": "遷移與待處理草稿診斷",
  "designUpgrade.none": "無",
  "designUpgrade.diff": "語意變更",
  "designUpgrade.breaking": "不相容變更",
  "designUpgrade.screens": "受影響的頁面",
  "designUpgrade.usages": "受影響的引用",
  "designUpgrade.overrides": "無效的明確覆寫",
  "designUpgrade.bindings": "已審查的綁定變更",
  "designUpgrade.code": "程式碼影響",
  "designUpgrade.coverage": "程式碼影響涵蓋已登錄的綁定。原始碼變更會保守地納入設計系統頁面；Token 引用尚未建立索引。",
  "designUpgrade.documents": "目前與提議的解析後文件",
  "designUpgrade.proof": "確切的審查依據",
  "designUpgrade.loading": "載入中…",
  "designUpgrade.source": "目前版本",
  "designUpgrade.readOnly": "你可以審查此升級，但套用升級需要專案寫入權限。",

  "designVersions.states": "狀態",
  "designVersions.title": "版本",
  "designVersions.publishCurrent": "發佈目前登錄表",
  "designVersions.publishHint": "將目前元件登錄表、繫結、策略和所選原始檔凍結為不可變版本。",
  ...
  "designVersions.catalog": "已發佈版本",
  "designVersions.chooseVersion": "選擇版本",
  "designVersions.packageDigest": "套件摘要",
  "designVersions.sourceDigest": "原始碼摘要",
  "designVersions.lockTitle": "專案版本鎖定",
  "designVersions.unlocked": "目前未啟用設計系統版本。",
  "designVersions.range": "允許的版本範圍",
  "designVersions.activate": "啟用確切版本",
  "designVersions.activateHint": "版本範圍用於記錄您的意圖。專案將保留所選確切版本，直到您明確變更。",
  "designVersions.resolve": "驗證專案鎖定",
  "designVersions.resolved": "已驗證鎖定的原始碼和中繼資料。",
  "designVersions.clear": "清除目前相依項目",
  "designVersions.clearHint": "保留目前可編輯的登錄表，並明確移除相依項目及確切版本鎖定。",
  "designVersions.published": "版本已發佈。專案鎖定未變更。",
  "designVersions.imported": "套件已匯入。專案鎖定未變更。",
  "designVersions.activated": "所選確切版本現已啟用。",
  "designVersions.cleared": "已清除目前相依項目及鎖定。",
  "designVersions.staleRead": "專案狀態已變更。使用此結果前請重新整理版本清單；您的表單編輯已保留。",
  "designVersions.integrityHint": "無法驗證目前版本。請查看診斷資訊，然後明確清除相依項目，以使用可編輯的登錄表。",
  "designVersions.advanced": "套件匯入與匯出",
  "designVersions.importPackage": "匯入套件",
  "designVersions.exportPackage": "匯出所選套件",
  "designVersions.importHint": "選擇完整的設計系統套件 JSON 檔案，檢查其識別資訊後再匯入。此格式支援二進位原始碼項目。",
  "designVersions.invalidPackage": "此檔案不是有效的設計系統套件。",
  "designVersions.metadata": "版本內容",
  "designVersions.tokens": "設計權杖",
  "designVersions.patterns": "模式",
  "designVersions.codeCompatibility": "程式碼相容性",
  "designVersions.sourceEvidence": "已凍結的原始檔",
  "designVersions.explore": "探索",
  "designVersions.guided": "引導",
  "designVersions.strict": "嚴格",
  "designVersions.off": "關閉",
  "designVersions.warning": "警告",
  "designVersions.error": "錯誤",
  "designVersions.unknownComponents": "未知元件",
  "designVersions.unknownProps": "未知屬性",
  "designVersions.invalidVariants": "無效變體",
  "designVersions.invalidSlots": "無效插槽",
  "designVersions.undeclaredTokens": "未宣告的權杖",
  "designVersions.rawColors": "原始色彩值",
  "designVersions.rawRadius": "原始圓角值",
  "designVersions.rawSpacing": "原始間距值",
  "designVersions.customControls": "自訂互動控制項",
  "designVersions.upgradeRequired": "變更鎖定版本需要經過審查的設計系統升級。",

  'semanticEditor.title': "語意樹",
  'semanticEditor.screen': "畫面編輯器",
  'semanticEditor.screenName': "畫面名稱",
  'semanticEditor.template': "元件範本",
  'semanticEditor.text': "文字",
  'semanticEditor.component': "元件",
  'semanticEditor.instance': "實例",
  'semanticEditor.reference': "元件參照",
  'semanticEditor.addNode': "新增節點",
  'semanticEditor.moveUp': "上移",
  'semanticEditor.moveDown': "下移",
  'semanticEditor.extract': "擷取共用元件",
  'semanticEditor.newComponent': "新增共用元件",
  'semanticEditor.override': "覆寫 {name}",
  'semanticEditor.reset': "重設為元件值",
  'semanticEditor.inherited': "繼承值",
  'semanticEditor.unset': "沒有繼承值",
  'semanticEditor.missingReference': "元件參照無法使用：{ref}",
  'semanticEditor.unknownProp': "未知屬性：{name}",
  'semanticEditor.unknownSlot': "未知插槽：{name}",
  'semanticEditor.invalidNumber': "請輸入有限數值。",
  'semanticEditor.noChoices': "沒有允許的選項",
  'semanticEditor.maxNodes': "此處最多允許 {count} 個節點。",
  'semanticEditor.drivenBy': "由公開屬性控制：{name}",
  'semanticEditor.mappedConflict': "此對應目標包含重複的明確值，請移除該值以恢復對應。",
  'semanticEditor.invalidChild': "此插槽不允許該節點。",
  'semanticEditor.invalidValue': "此值不符合宣告的屬性約束。",
  "designRuntime.framework": "框架",
  "designRuntime.metadataExport": "插槽中繼資料匯出（選填）",
  "designRuntime.metadataHint": "透過具名匯出宣告語意插槽及其明確的程式碼插槽目標。",
  "designRuntime.stories": "Storybook 範例",
  "designRuntime.storyHint": "匯入字面值 CSF3 範例。故事參數不會改變正式元件的預設值。",
  "designRuntime.storySource": "Storybook 原始檔",
  "designRuntime.storyExport": "故事匯出",
  "designRuntime.storyId": "穩定的故事 ID",
  "designRuntime.addStorySource": "新增 Storybook 原始檔",
  ...
  'designRuntime.conflict': "元件登錄表已變更。已載入最新修訂，請檢查草稿後重試。",
  ...
  'designRuntime.exportName': "匯出名稱",
  'designRuntime.identities': "穩定識別碼",
  'designRuntime.identityHint': "只指派一次；原始檔或匯出名稱變更後仍保留。",
  'designRuntime.componentId': "元件 ID",
  ...
  'designRuntime.optional': "選填",
  'designRuntime.multiple': "多個",
  'designRuntime.single': "單個",
  'designRuntime.binding': "程式碼繫結",
  'designRuntime.status': "狀態",
  'designRuntime.codeComponent': "程式碼元件",
  'designRuntime.propMappings': "屬性對應",
  'designRuntime.bind': "繫結",
  'designRuntime.unbind': "解除繫結",
  'designRuntime.revalidate': "重新驗證",
  'designRuntime.resolve': "解析繫結",
  'designRuntime.resolved': "已解析至 {name}。",
  'designRuntime.validate': "驗證屬性",
  'designRuntime.includeProp': "包含 {name}",
  'designRuntime.valueType': "值類型",
  'designRuntime.valid': "屬性值有效。",
  'designRuntime.props': "屬性",
  'designRuntime.status.bound': "已繫結",
  'designRuntime.status.unbound': "未繫結",
  'designRuntime.status.candidate': "候選",
  'designRuntime.status.stale': "已過期",
  'designRuntime.status.broken': "已損壞",
  'designRuntime.boundTarget': "目前目標",
  ...
  "settings.byokNoFileToolsNotice": "API 模式支援讀取、建立和修改專案檔案，需要可用的 OpenCode（本機安裝或應用程式隨附）。",
  ...
  "settings.privacy": "隱私",
  "settings.privacyHint": "管理已儲存的資料分享偏好。",
  "settings.privacyConsentKicker": "資料分享偏好",
  ...
  "settings.privacyConsentBannerFooter":
    "這些開關會儲存你的偏好。是否實際分享，還取決於目前環境的遙測設定。",
  "settings.privacyConsentPolicyLink": "資料處理說明",
  "settings.privacyMetrics": "匿名指標",
  "settings.privacyMetricsHint":
    "僅在目前環境已設定遙測且此選項開啟時，才允許傳送匿名使用指標。",
  "settings.privacyContent": "對話內容",
  "settings.privacyContentHint":
    "僅在目前環境已設定遙測且此選項開啟時，才允許傳送提示詞、助理回覆及工具輸入／輸出。",
  ...
  "settings.privacyDataDeletionHint":
    "更換匿名 ID 並關閉兩個遙測偏好選項。此操作不會刪除已傳送的資料；如有需要，請聯絡已設定的接收方。",
  "settings.about": "關於",
  ...
  "designFiles.fileTree": "檔案樹",
  "designFiles.categories": "依類型",
  "designFiles.expandAll": "全部展開",
  "designFiles.collapseAll": "全部摺疊",
  ...
  'projectStructure.codeTab': "程式碼元件",
  'projectStructure.title': "專案結構",
  'projectStructure.screens': "頁面",
  'projectStructure.sharedComponents': "共用元件",
  'projectStructure.newScreen': "新增頁面",
  'projectStructure.empty': "建立頁面或共用元件，開始編輯專案結構。",
  'projectStructure.componentName': "元件名稱",
  'projectStructure.draft': "本機草稿",
  'projectStructure.staged': "已暫存變更",
  'projectStructure.published': "已發佈",
  'projectStructure.documentDraft': "頁面編輯會保留在此草稿中，儲存文件後才會生效。",
  'projectStructure.saveDocument': "儲存文件",
  'projectStructure.validateDocument': "驗證文件",
  'projectStructure.documentValid': "文件有效。",
  'projectStructure.discardEdits': "捨棄本機編輯",
  'projectStructure.documentConflict': "已儲存的文件發生變化。你的草稿已保留。捨棄草稿以載入已儲存版本，或明確選擇將草稿套用至最新修訂。",
  'projectStructure.useDraft': "將我的草稿套用至最新修訂",
  'projectStructure.componentConflict': "此元件已有較新的已發佈修訂或暫存變更。暫存前請重新載入，或明確將草稿基於最新狀態更新。",
  'projectStructure.rebase': "更新草稿基準",
  'projectStructure.stage': "暫存變更",
  'projectStructure.reviewImpact': "檢視影響",
  'projectStructure.impact': "變更影響",
  'projectStructure.impactHint': "影響分析會比較已發佈定義與此暫存變更在已儲存頁面中的結果，不包含未儲存的頁面編輯。",
  'projectStructure.publish': "發佈變更",
  'projectStructure.discardStage': "捨棄暫存變更",
  'projectStructure.unstaged': "編輯器內容與暫存變更不同。發佈前請先暫存這些編輯。",
  'projectStructure.reviewAgain': "發佈前請基於目前專案修訂重新檢視影響。",
  'projectStructure.affectedScreens': "受影響的頁面",
  'projectStructure.directUsages': "直接使用位置",
  'projectStructure.dependencyChains': "相依鏈",
  'projectStructure.current': "目前",
  'projectStructure.proposed': "提議",
  'projectStructure.history': "發佈歷程",
  'projectStructure.stageUndo': "暫存復原至修訂 {revision}",
  'projectStructure.references': "參照與刪除",
  'projectStructure.analyzeDeletion': "分析參照與刪除",
  'projectStructure.deletionAction': "刪除動作",
  'projectStructure.safeDelete': "僅在未使用時刪除",
  'projectStructure.replace': "替換參照",
  'projectStructure.detachAll': "分離參照",
  'projectStructure.deleteInstances': "刪除元件及其執行個體",
  'projectStructure.replacement': "替換元件",
  'projectStructure.deleteComponent': "執行刪除動作",
  'projectStructure.deletionHint': "此動作會更新已儲存的專案及其參照。請先儲存或捨棄頁面草稿。",
  'projectStructure.detach': "分離執行個體",
  'projectStructure.detachMode': "驗證模式",
  'projectStructure.explore': "探索",
  'projectStructure.guided': "引導",
  'projectStructure.strict': "嚴格",
  'projectStructure.previewDetach': "預覽分離後的內容",
  'projectStructure.adoptDetach': "在草稿中使用分離後的內容",
  'projectStructure.extractHint': "先暫存並發佈此共用元件，再將其執行個體用於頁面草稿並儲存文件。",
  'projectStructure.adoptExtraction': "在頁面中使用已發佈元件",
  'projectStructure.sourceChanged': "來源節點已變更或遭移除。你的草稿已保留；請重新擷取，或從目前節點進行分離。",
  'projectStructure.publicProps': "公開屬性",
  'projectStructure.addProp': "新增公開屬性",
  'projectStructure.propName': "屬性名稱",
  'projectStructure.propType': "屬性類型",
  'projectStructure.hasDefault': "有預設值",
  'projectStructure.defaultValue': "預設值",
  'projectStructure.enumValues': "列舉值",
  'projectStructure.addValue': "新增值",
  'projectStructure.addMapping': "新增對應",
  'projectStructure.mappingSource': "公開屬性",
  'projectStructure.mappingTarget': "範本目標",
  'projectStructure.chooseTarget': "選擇範本目標",
  'projectStructure.mappingHint': "對應目標繼承公開屬性。暫存前請移除範本中重複的明確值。",
  'projectStructure.nameRequired': "請輸入唯一且有效的屬性名稱。",
  'projectStructure.templateRequired': "暫存前請新增一個範本根節點。",
  'projectStructure.staleRead': "載入此結果時專案發生變化。你的草稿已保留；請檢視最新狀態後重試。",
  'projectStructure.conflict': "已載入最新專案狀態。你的草稿已保留；重試前請檢視變更。",
  'designValidation.title': "驗證",
  'designValidation.description': "根據專案原始碼檔案和生效的設計規則檢查已儲存的語意頁面。",
  'designValidation.mode': "專案模式",
  'designValidation.modeHint': "請先儲存模式，再執行驗證。探索和引導模式使用已設定的嚴重程度；嚴格模式要求完整證據。",
  'designValidation.saveSettings': "儲存驗證設定",
  'designValidation.effectivePolicy': "生效規則",
  'designValidation.projectPolicy': "專案規則",
  'designValidation.lockedPolicy': "鎖定套件規則",
  'designValidation.lockedHint': "規則由精確鎖定的套件提供。編輯這些約束前，請先清除相依項目。",
  'designValidation.recoveryHint': "無法驗證鎖定套件。若要復原，請在此明確儲存探索模式，再到版本面板清除相依項目。",
  'designValidation.sourceHint': "請選擇進入點檔案及所有匯入的應用程式原始碼或樣式表。背景服務會讀取原始碼位元組和已安裝的套件。",
  'designValidation.outputs': "頁面輸出",
  'designValidation.addOutput': "新增輸出",
  'designValidation.screen': "語意頁面",
  'designValidation.unmapped': "未對應 — 僅提供參考分析",
  'designValidation.run': "驗證產物",
  'designValidation.strictReady': "嚴格模式證據完整",
  'designValidation.notReady': "嚴格模式證據不完整",
  'designValidation.accepted': "已儲存的規則允許通過",
  'designValidation.rejected': "已儲存的規則拒絕通過",
  'designValidation.coverage': "證據涵蓋範圍",
  'designValidation.metrics': "實測結果",
  'designValidation.semantic': "語意文件",
  'designValidation.source': "靜態原始碼",
  'designValidation.imports': "匯入關係圖",
  'designValidation.styles': "樣式",
  'designValidation.bindings': "正式程式碼綁定",
  'designValidation.conformance': "原始碼與語意頁面一致",
  'designValidation.componentReuse': "元件重用",
  'designValidation.bindingReuse': "綁定重用",
  'designValidation.semanticReuse': "已知語意元件",
  'designValidation.intrinsicControls': "HTML 原生控制項",
  'designValidation.duplicateControls': "已有綁定替代項的控制項",
  'designValidation.duplicateStructures': "重複的控制項結構",
  'designValidation.unsupported': "不支援的結構",
  'designValidation.unresolvedImports': "無法解析的匯入",
  'designValidation.staleResult': "產生此結果後專案已發生變更。請重新驗證以查看目前情況。",
  'designValidation.settingsConflict': "專案已發生變更。設定草稿已保留；請重新整理並使用目前修訂版本後再儲存。",
  'designValidation.rebase': "使用目前修訂版本",
  'designValidation.dirtyHint': "有尚未儲存的設定。產物驗證使用已儲存的模式和規則。",
  'designValidation.noSources': "請至少選擇一個原始碼檔案和一個頁面輸出。",
  'designValidation.clearHint': "清除已驗證的相依項目會保留其約束和你選擇的模式。",

  'designHandoff.title': "交付",
  'designHandoff.description': "將可重用的專案元件連接到正式程式碼，再審閱並匯出工程交付內容。",
  'designHandoff.framework': "框架",
  'designHandoff.localCode': "本機元件實作",
  'designHandoff.localComponent': "可重用元件",
  'designHandoff.definitionRevision': "定義修訂版本 {revision}",
  'designHandoff.implementation': "實作",
  'designHandoff.registerSource': "註冊專案原始碼檔案",
  'designHandoff.existingCode': "使用已註冊程式碼或設計系統程式碼",
  'designHandoff.bindingId': "綁定 ID",
  'designHandoff.register': "驗證並綁定實作",
  'designHandoff.noLocal': "請在結構面板建立可重用元件，再註冊其實作。",
  'designHandoff.mappingHint': "屬性對應使用 designProp 和 codeProp。如需明確型別的值轉換，請新增 valueTransform: {\"type\":\"map\",\"entries\":[{\"from\":\"primary\",\"to\":\"filled\"}]}。插槽對應使用 designSlot 和 codeSlot。",
  'designHandoff.valueTransform': "值轉換（JSON）",
  'designHandoff.transformHint': "留空表示保持原值。使用 {\"valueTransform\":{\"type\":\"map\",\"entries\":[{\"from\":\"primary\",\"to\":\"filled\"}]}}。現有舊版 values 對應在編輯前會保留。",
  'designHandoff.invalidTransform': "請輸入僅包含 values 或 valueTransform 的 JSON 物件。",
  'designHandoff.refreshFiles': "重新載入狀態與檔案清單",
  'designHandoff.sourceProof': "背景服務會驗證凍結的設計系統位元組、目前已註冊的原始碼，以及實際安裝的套件版本。程式碼產生會傳回可下載的檔案。",
  'designHandoff.handoffId': "交付 ID",
  'designHandoff.changeContext': "已發佈的變更脈絡（選填）",
  'designHandoff.previousVersion': "精確的前一版設計系統版本",
  'designHandoff.create': "建立交付",
  'designHandoff.outputs': "頁面輸出檔案",
  'designHandoff.emit': "產生正式程式碼",
  'designHandoff.ready': "已就緒",
  'designHandoff.notReady': "尚未就緒",
  'designHandoff.downloadManifest': "下載交付 JSON",
  'designHandoff.downloadCode': "下載程式碼",
  'designHandoff.registeredCode': "已註冊的專案程式碼",
  'designHandoff.refreshHint': "重新整理會再次讀取已註冊的原始碼。程式碼無法使用或已變更時，綁定會維持損壞或過期狀態，直到明確重新驗證成功。",
  'designHandoff.refreshCode': "重新整理原始碼",
  'designHandoff.conflict': "專案已發生變更。綁定草稿已保留。請重新載入綁定後再提交。",
  'designHandoff.dirty': "有尚未儲存的綁定編輯。選擇其他元件或框架前，請先儲存或重新載入。",
  ...
  'designPreview.title': "預覽",
  'designPreview.open': "預覽元件",
  'designPreview.hint': "從選定專案修訂版轉譯實際的 React 或 Vue 元件。比較為唯讀操作。",
  'designPreview.kind': "預覽類型",
  'designPreview.semantic': "語意設計",
  'designPreview.production': "正式程式碼交付",
  'designPreview.framework': "框架",
  'designPreview.draft': "共用元件草稿",
  'designPreview.currentOnly': "僅目前快照",
  'designPreview.sharedComparison': "共用元件草稿比較",
  'designPreview.upgradeComparison': "已審查升級比較",
  'designPreview.clearComparison': "清除比較",
  'designPreview.semanticHint': "本機定義展開為其繼承範本，並透過凍結的設計系統原始碼轉譯。專案實作不會被重用為提議範本的驗證依據。",
  'designPreview.productionHint': "轉譯目前正式實作。每一側的本機繫結、原始碼證明及已安裝套件相容性都必須有效。",
  'designPreview.screens': "頁面（最多六個）",
  'designPreview.noScreens': "預覽前請先儲存一個語意頁面。",
  'designPreview.building': "正在建置預覽…",
  'designPreview.build': "建置預覽",
  'designPreview.failed': "無法準備預覽。",
  'designPreview.stale': "所選專案快照已變更。請重新建置預覽。",
  'designPreview.impact': "比較範圍",
  'designPreview.selected': "選定的視覺樣本",
  'designPreview.affected': "參照圖或升級審查中的受影響頁面",
  'designPreview.none': "無",
  'designPreview.sampleHint': "選定頁面是視覺樣本。受影響頁面清單保留完整的參照圖或審查範圍；診斷會指出證據不完整的情況。",
  'designPreview.current': "目前",
  'designPreview.proposed': "提議",
  'designPreview.revision': "專案修訂版",
  'designPreview.unavailable': "無法轉譯這一側。請查看上方診斷。",
  'designPreview.evidence': "原始碼和套件證據",
  'designPreview.runtimeHint': "框架執行階段版本由 OpenDesign 提供。專案已安裝套件的觀測結果與凍結的設計系統原始碼分別列出。",
  'designPreview.telemetryHint': "已轉譯狀態反映瀏覽器執行情況，不代表正式環境合規認證。執行階段錯誤和被封鎖的能力仍會顯示。",
  'designPreview.loading': "正在載入元件執行階段…",
  'designPreview.rendered': "已轉譯",
  'designPreview.error': "轉譯失敗",
  'designPreview.timeout': "元件執行階段未在逾時前回報完成轉譯。",
  'designPreview.runtimeError': "元件執行階段發生錯誤。",

  "designGeneration.title": "設計驗證",
  "designGeneration.running": "正在產生",
  "designGeneration.repairing": "正在修復",
  "designGeneration.succeeded": "產生已完成",
  "designGeneration.blocked": "交付遭阻擋",
  "designGeneration.canceled": "產生已取消",
  "designGeneration.unconfirmed": "等待交付確認",
  "designGeneration.initial": "首次嘗試",
  "designGeneration.repair": "修復嘗試 1/1",
  "designGeneration.repairHint": "背景服務正在依已儲存的設計策略進行一次修復嘗試，交付仍待確認。",
  "designGeneration.blockedHint": "未符合已儲存的設計策略。請先查看診斷，再提出新請求。",
  "designGeneration.mode": "已儲存的模式",
  "designGeneration.revision": "專案修訂版本",
  "designGeneration.decision": "驗證結論",
  "designGeneration.advisory": "已交付，附有提示",
  "designGeneration.accepted": "驗證通過",
  "designGeneration.notApplicable": "沒有適用的設計輸出",
  "designGeneration.repairRequired": "需要修復",
  "designGeneration.inventoryComplete": "原始碼檔案清單完整。",
  "designGeneration.inventoryIncomplete": "原始碼檔案清單不完整，無法確認涵蓋範圍。",
  "designGeneration.evidence": "報告與原始碼證據",
  "designGeneration.reportHint": "驗證證據對應記錄中的原始碼快照和已儲存的策略。僅程序結束並不能證明交付已通過驗證。",
  "designGeneration.changed": "已變更的原始碼檔案",
  "designGeneration.deleted": "已刪除的原始碼檔案",
  "designGeneration.outputs": "已宣告的輸出檔案",
  "designGeneration.none": "無",
  "designGeneration.pending": "目前嘗試結束後將顯示驗證證據。",
  "designOverview.lockedVersion": "已鎖定 · {version}",
  "designOverview.editingVersion": "以 {version} 為基礎編輯",
  "designOverview.unpublished": "尚未發布的元件集合",
  "designOverview.lockedHint": "此專案使用一個確定的已發布版本，樣式和來源檔案隨該版本凍結保存。",
  "designOverview.editingHint": "樣式和來源檔案沿用編輯基準保留。完成修改後即可發布新版本。",
  "designOverview.unpublishedHint": "你可以編輯此元件集合。發布版本後即可保留其樣式和來源檔案。",
  "designOverview.foundations": "設計基礎",
  "designOverview.codeComponents": "程式碼元件",
  "designOverview.pages": "頁面",
  "designOverview.sources": "保留的來源檔案",
  "designOverview.versionContents": "查看版本內容",
  "designOverview.manageVersion": "管理版本",
  "designOverview.continueEditing": "繼續編輯",
  "designOverview.lockedNext": "如需修改，請先在版本管理中解除目前的依賴。已發布的版本保持不變。",
  "designOverview.loading": "正在載入版本內容…",
  "designOverview.unavailable": "無法驗證版本內容，請重新整理後再試。",
  "designOverview.notPublished": "尚未發布",
  "designOverview.metadataOnly": "設計變數和來源檔案與程式碼元件、頁面分開保存。",

  "settings.byokRuntimeMissing": "未偵測到可用的 OpenCode",
  "settings.byokRuntimeMissingHint": "暫時無法啟動 API 任務。請安裝 OpenCode 後重新掃描，或重新掃描現有安裝。",
  "settings.byokRuntimeReady": "OpenCode 可用",
  "settings.byokRuntimeConnectionHint": "連線測試僅檢查 API 供應商，不驗證 OpenCode 能否啟動。",
  ...
  "settings.privacyConfigured": "目前環境已設定遙測。是否傳送還取決於資料類型及對應設定；此狀態不代表正在上傳。",
  "settings.privacyUnconfigured": "目前環境未設定遙測傳送。開關表示已儲存的偏好，不代表正在上傳。",
  "settings.privacyConfigurationUnknown": "暫時無法確認目前環境的遙測設定。開關僅表示已儲存的偏好。",
  "settings.privacyProviderHint": "模型請求仍由你選擇的供應商處理，不受這兩個遙測偏好開關控制。",
};
