...
import { composeSystemPrompt as composeContracts, renderDesignGenerationDirective, OD_NEXT_PROMPT_STAGE_CONTRACT_V2, type OdNextStrategyRequestRecipeV2 } from '@open-design/contracts';
