...
const OPEN_DESIGN_GITHUB_REPO_API = `https://api.github.com/repos${new URL(DESIGN_LOOM_PRODUCT.repositoryUrl).pathname}`;
const OPEN_DESIGN_GITHUB_RELEASE_LATEST_API = `${OPEN_DESIGN_GITHUB_REPO_API}/releases/latest`;
